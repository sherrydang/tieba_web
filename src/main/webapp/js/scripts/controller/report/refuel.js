define(['app', 'service/report/refuel'], function (app) {
    'use strict';
    app.controller('RefuelCountCtrl', RefuelCountCtrl);
});
function RefuelCountCtrl($scope, RefuelCountService) {
    var object;
    ...
    $scope.gridOptions = {
        ...
        onRegisterApi: function (gridApi) {
            ...
            $scope.choose = function () {
                ...
                RefuelCountService.result($scope.object, $scope.page).success(function (data) {
                    $scope.gridOptions.data = data.result.resultList;
                    console.log($scope.resultList);
                    drawRefuelCharts(data.result.resultList);
                });
            }
            ...
            $scope.exportExcel = function () {
                ...
                if (object != null) {
                    RefuelCountService.report(object).success(function (data) {
                        console.log(data);
                        if (data.code == 405) {
                            alert("暂无数据！");
...
function drawRefuelCharts(data) {
    ...
    $('#refuel-chart').highcharts({
        ...
        tooltip: {
            ...
            pointFormat: '当日加油量: <b>{point.y:.1f} 升</b>'
        },
        series: [{
            name: '加油量',
            data: formatData,
...
//    RefuelCountService.objects().success(function (data) {
