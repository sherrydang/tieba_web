define(['app', 'service/report/recharge'], function (app) {
    'use strict';
    app.controller('RechargeCountCtrl', RechargeCountCtrl);
});
function RechargeCountCtrl($scope, RechargeCountService) {
    var object;
    ...
    $scope.gridOptions = {
        ...
        onRegisterApi: function (gridApi) {
            ...
            $scope.exportExcel = function () {
                ...
                if (object != null) {
                    RechargeCountService.report(object).success(function (data) {
                        console.log(data);
                        if (data.code == 405) {
                            alert("暂无数据！");
...
function drawRechargeCharts(data) {
    ...
    $('#recharge-chart').highcharts({
        ...
        tooltip: {
            ...
            pointFormat: '当日充值次数: <b>{point.y} 次</b>'
        },
        series: [{
            name: '充值数',
            data: formatData,
...
//    RechargeCountService.objects().success(function (data) {
