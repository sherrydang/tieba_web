/*!
 * ui-grid - v3.0.0-rc.20-abe55b9 - 2015-02-26
...
!function () {
            ...
            return {
                pre: function (b, e, f, g) {
                    ...
                    if (g && b.col.compiledElementFn)h(); else if (g && !b.col.compiledElementFn)b.col.getCompiledElementFn().then(function (a) {
                        ...
                        var i = b.col.cellTemplate.replace(d.MODEL_COL_FIELD, "row.entity." + c.preEval(b.col.field)).replace(d.COL_FIELD, "grid.getCellValue(row, col)"), j = a(i)(b);
                        e.append(j)
                    }
                }, post: function (a, b) {
                    var c = a.col.getColClass(!1);
                    b.addClass(c);
                    var e, f = function () {
                        var c = b;
                        e && (c.removeClass(e), e = null), e = angular.isFunction(a.col.cellClass) ? a.col.cellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.cellClass, c.addClass(e)
                    };
                    a.col.cellClass && f();
                    var g = a.grid.registerDataChangeCallback(f, [d.dataChange.COLUMN, d.dataChange.EDIT]), h = function (d, g) {
                        if (d !== g) {
                            (e || a.col.cellClass) && f();
                            var h = a.col.getColClass(!1);
                            h !== c && (b.removeClass(c), b.addClass(h), c = h)
                        }
                    }, i = a.$watch("col", h), j = a.$watch("row", h), k = function () {
                        g(), i(), j()
                    };
                    a.$on("$destroy", k), b.on("$destroy", k)
                }
            }
        }
    };
    ...
    angular.module("ui.grid").service("uiGridColumnMenuService", ["i18nService", "uiGridConstants", "gridUtil", function (a, b, c) {
        var d = {
            initialize: function (a, b) {
                ...
                return a.col && a.col.colDef && a.col.colDef.suppressRemoveSort ? !0 : !1
            }, hideable: function (a) {
                return "undefined" != typeof a.col && a.col && a.col.colDef && a.col.colDef.enableHiding === !1 ? !1 : !0
            }, getDefaultMenuItems: function (c) {
                return [{
                    title: a.getSafeText("sort.ascending"), icon: "ui-grid-icon-sort-alt-up", action: function (a) {
                ...
                var e = {};
                return e.left = d[0].offsetLeft, e.top = d[0].offsetTop, e.offset = 0, b.grid.options.offsetLeft && (e.offset = b.grid.options.offsetLeft), e.height = c.elementHeight(d, !0), e.width = c.elementWidth(d, !0), e
            }, repositionMenu: function (a, b, d, e, f) {
                var g = e[0].querySelectorAll(".ui-grid-menu"), h = b.renderContainer ? b.renderContainer : "body", i = (b.grid.renderContainers[h], c.closestElm(f, ".ui-grid-render-container")), j = i.getBoundingClientRect().left - a.grid.element[0].getBoundingClientRect().left, k = i.querySelectorAll(".ui-grid-viewport")[0].scrollLeft, l = b.lastMenuWidth ? b.lastMenuWidth : a.lastMenuWidth ? a.lastMenuWidth : 170, m = b.lastMenuPaddingRight ? b.lastMenuPaddingRight : a.lastMenuPaddingRight ? a.lastMenuPaddingRight : 10;
                if (0 !== g.length) {
                ...
                var o = d.left + j - k + d.width - l + m;
                o < d.offset && (o = d.offset), e.css("left", o + "px"), e.css("top", d.top + d.height + "px")
            }
        };
        return d
    }]).directive("uiGridColumnMenu", ["$timeout", "gridUtil", "uiGridConstants", "uiGridColumnMenuService", function (a, b, c, d) {
        var e = {
            priority: 0,
            scope: !0,
            require: "?^uiGrid",
            ...
            link: function (b, e, f, g) {
                var h = this;
                d.initialize(b, g), b.defaultMenuItems = d.getDefaultMenuItems(b), b.menuItems = b.defaultMenuItems, d.setColMenuItemWatch(b), b.showMenu = function (a, c, f) {
                    b.col = a;
                    var g = d.getColumnElementPosition(b, a, c);
                    b.menuShown ? (b.colElement = c, b.colElementPosition = g, b.hideThenShow = !0, b.$broadcast("hide-menu", {originalEvent: f})) : (h.shown = b.menuShown = !0, d.repositionMenu(b, a, g, e, c), b.colElement = c, b.colElementPosition = g, b.$broadcast("show-menu", {originalEvent: f}))
                }, b.hideMenu = function (a) {
                    b.menuShown = !1, a || b.$broadcast("hide-menu")
                }, b.$on("menu-hidden", function () {
                    b.hideThenShow ? (delete b.hideThenShow, d.repositionMenu(b, b.col, b.colElementPosition, e, b.colElement), b.$broadcast("show-menu"), b.menuShown = !0) : b.hideMenu(!0)
                }), b.$on("menu-shown", function () {
                    a(function () {
                        d.repositionMenu(b, b.col, b.colElementPosition, e, b.colElement), delete b.colElementPosition, delete b.columnElement
                    }, 200)
                }), b.sortColumn = function (a, c) {
                    a.stopPropagation(), b.grid.sortColumn(b.col, c, !0).then(function () {
                        b.grid.refresh(), b.hideMenu()
                    })
                }, b.unsortColumn = function () {
                    b.col.unsort(), b.grid.refresh(), b.hideMenu()
                }, b.hideColumn = function () {
                    b.col.colDef.visible = !1, b.grid.refresh(), b.hideMenu(), b.grid.api.core.notifyDataChange(c.dataChange.COLUMN), b.grid.api.core.raise.columnVisibilityChanged(b.col)
                }
            },
    ...
    angular.module("ui.grid").directive("uiGridFooterCell", ["$timeout", "gridUtil", "uiGridConstants", "$compile", function (a, b, c, d) {
        var e = {
            ...
            compile: function () {
                return {
                    pre: function (a, b) {
                        var c = d(a.col.footerCellTemplate)(a);
                        b.append(c)
                    }, post: function (a, b, d, e) {
                        a.grid = e.grid, b.addClass(a.col.getColClass(!1));
                        var f, g = function () {
                            var c = b;
                            f && (c.removeClass(f), f = null), f = angular.isFunction(a.col.footerCellClass) ? a.col.footerCellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.footerCellClass, c.addClass(f)
                        };
                        a.col.footerCellClass && g();
                        var h = a.grid.registerDataChangeCallback(g, [c.dataChange.COLUMN]);
                        a.$on("$destroy", h)
                    }
                }
            }
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridFooter", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d) {
        var e = "ui-grid/ui-grid-footer";
        return {
            restrict: "EA",
            replace: !0,
            ...
            compile: function () {
                return {
                    pre: function (a, c, f, g) {
                        var h = g[0], i = g[1];
                        a.grid = h.grid, a.colContainer = i.colContainer, i.footer = c;
                        var j = a.grid.options.footerTemplate ? a.grid.options.footerTemplate : e;
                        d.getTemplate(j).then(function (d) {
                            var e = angular.element(d), f = b(e)(a);
                            if (c.append(f), i) {
                                var g = c[0].getElementsByClassName("ui-grid-footer-viewport")[0];
                                g && (i.footerViewport = g)
                            }
                        })
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridGridFooter", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d) {
        var e = "ui-grid/ui-grid-grid-footer";
        return {
            restrict: "EA", replace: !0, require: "^uiGrid", scope: !0, compile: function () {
                return {
                    pre: function (a, c, f, g) {
                        a.grid = g.grid;
                        var h = a.grid.options.gridFooterTemplate ? a.grid.options.gridFooterTemplate : e;
                        d.getTemplate(h).then(function (d) {
                            var e = angular.element(d), f = b(e)(a);
                            c.append(f)
                        })
                    }, post: function () {
    ...
    angular.module("ui.grid").directive("uiGridGroupPanel", ["$compile", "uiGridConstants", "gridUtil", function (a, b, c) {
        ...
        return {
            restrict: "EA", replace: !0, require: "?^uiGrid", scope: !1, compile: function () {
                return {
                    pre: function (b, e) {
                        var f = b.grid.options.groupPanelTemplate || d;
                        c.getTemplate(f).then(function (c) {
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridHeaderCell", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", "ScrollEvent", function (a, b, c, d, e, f) {
        var g = 500, h = {
            priority: 0,
            scope: {col: "=", row: "=", renderIndex: "="},
            require: ["?^uiGrid", "^uiGridRenderContainer"],
            ...
            compile: function () {
                return {
                    pre: function (b, c) {
                        var d = a(b.col.headerCellTemplate)(b);
                        c.append(d)
                    }, post: function (a, c, d, h) {
                        function i(b) {
                            var c = !1;
                            b.shiftKey && (c = !0), j.grid.sortColumn(a.col, c).then(function () {
                                j.columnMenuScope && j.columnMenuScope.hideMenu(), j.grid.refresh()
                            })
                        }

                        var j = h[0], k = h[1];
                        a.grid = j.grid, a.renderContainer = j.grid.renderContainers[k.containerId];
                        var l = a.col.getColClass(!1);
                        c.addClass(l), a.menuShown = !1, a.asc = f.ASC, a.desc = f.DESC;
                        var m, n = (angular.element(c[0].querySelectorAll(".ui-grid-header-cell-menu")), angular.element(c[0].querySelectorAll(".ui-grid-cell-contents"))), o = function () {
                            var b = c;
                            m && (b.removeClass(m), m = null), m = angular.isFunction(a.col.headerCellClass) ? a.col.headerCellClass(a.grid, a.row, a.col, a.rowRenderIndex, a.colRenderIndex) : a.col.headerCellClass, b.addClass(m);
                            var d = a.grid.renderContainers.right ? a.grid.renderContainers.right : a.grid.renderContainers.body;
                            a.isLastCol = a.col === d.visibleColumnCache[d.visibleColumnCache.length - 1]
                        };
                        a.$watch("col", function (b, d) {
                            if (b !== d) {
                                var e = a.col.getColClass(!1);
                                e !== l && (c.removeClass(l), c.addClass(e), l = e)
                            }
                        }), o();
                        var p = a.grid.registerDataChangeCallback(o, [f.dataChange.COLUMN]);
                        if (a.$on("$destroy", p), a.sortable = j.grid.options.enableSorting && a.col.enableSorting ? !0 : !1, a.filterable = j.grid.options.enableFiltering && a.col.enableFiltering ? !0 : !1, a.colMenu = a.col.grid.options && a.col.grid.options.enableColumnMenus !== !1 && a.col.colDef && a.col.colDef.enableColumnMenu !== !1 ? !0 : !1, a.sortable || a.colMenu) {
                            var q, r = 0, s = e.isTouchEnabled() ? "touchstart" : "mousedown";
                            n.on(s, function (d) {
                                d.stopPropagation(), "undefined" != typeof d.originalEvent && void 0 !== d.originalEvent && (d = d.originalEvent), d.button && 0 !== d.button || (r = (new Date).getTime(), q = b(function () {
                                }, g), q.then(function () {
                                    a.colMenu && j.columnMenuScope.showMenu(a.col, c, d)
                                }), j.fireEvent(f.events.COLUMN_HEADER_CLICK, {
                                    event: d,
                                    columnName: a.col.colDef.name
                                }))
                            });
                            var t = e.isTouchEnabled() ? "touchend" : "mouseup";
                            n.on(t, function () {
                                b.cancel(q)
                        ...
                        if (a.toggleMenu = function (b) {
                                b.stopPropagation(), j.columnMenuScope.menuShown && j.columnMenuScope.col === a.col ? j.columnMenuScope.hideMenu() : j.columnMenuScope.showMenu(a.col, c)
                            }, a.sortable) {
                            var u = e.isTouchEnabled() ? "touchend" : "click";
                            n.on(u, function (a) {
                                a.stopPropagation(), b.cancel(q);
                                var c = (new Date).getTime(), d = c - r;
                                d > g || i(a)
                            }), a.$on("$destroy", function () {
                                b.cancel(q)
                            })
                        ...
                        if (a.filterable) {
                            var v = [];
                            angular.forEach(a.col.filters, function (b, c) {
                                v.push(a.$watch("col.filters[" + c + "].term", function (a, b) {
                                    a !== b && (j.grid.api.core.raise.filterChanged(), j.grid.refresh(!0))
                                }))
                            }), a.$on("$destroy", function () {
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridHeader", ["$templateCache", "$compile", "uiGridConstants", "gridUtil", "$timeout", function (a, b, c, d) {
        var e = "ui-grid/ui-grid-header", f = "ui-grid/ui-grid-no-header";
        return {
            restrict: "EA",
            replace: !0,
            require: ["^uiGrid", "^uiGridRenderContainer"],
            ...
            compile: function () {
                return {
                    pre: function (a, c, g, h) {
                        function i() {
                            k.header = k.colContainer.header = c;
                            var a = c[0].getElementsByClassName("ui-grid-header-canvas");
                            k.headerCanvas = a.length > 0 ? k.colContainer.headerCanvas = a[0] : null
                        }

                        var j = h[0], k = h[1];
                        a.grid = j.grid, a.colContainer = k.colContainer, i();
                        var l;
                        l = a.grid.options.showHeader ? a.grid.options.headerTemplate ? a.grid.options.headerTemplate : e : f, d.getTemplate(l).then(function (d) {
                            var e = angular.element(d), f = b(e)(a);
                            if (c.replaceWith(f), c = f, i(), k) {
                                var g = c[0].getElementsByClassName("ui-grid-header-viewport")[0];
                                g && (k.headerViewport = g)
                            }
                            a.grid.queueRefresh()
                        })
                    }, post: function (a, b, c, e) {
                        function f() {
                            var a = h.colContainer.getViewportWidth() - i.scrollbarWidth, b = h.colContainer.visibleColumnCache, c = 0, e = 0, f = 0, g = a, j = !1, k = function (b) {
                                return "manual" === b.widthType ? +b.width : "percent" === b.widthType ? parseInt(b.width.replace(/%/g, ""), 10) * a / 100 : "auto" === b.widthType ? (0 === f && (f = parseInt(g / e, 10)), b.width.length * f) : void 0
                            };
                            b.forEach(function (a) {
                                a.widthType = null, isFinite(+a.width) ? a.widthType = "manual" : d.endsWith(a.width, "%") ? (a.widthType = "percent", j = !0) : angular.isString(a.width) && -1 !== a.width.indexOf("*") && (a.widthType = "auto", e += a.width.length, j = !0)
                            });
                            var l = ["manual", "percent", "auto"];
                            if (b.filter(function (a) {
                                    return a.visible && a.widthType
                                }).sort(function (a, b) {
                                    return l.indexOf(a.widthType) - l.indexOf(b.widthType)
                                }).forEach(function (a) {
                                    var b = k(a);
                                    a.minWidth && (b = Math.max(b, a.minWidth)), a.maxWidth && (b = Math.min(b, a.maxWidth)), a.drawnWidth = Math.floor(b), c += a.drawnWidth, g -= a.drawnWidth
                                }), j && g > 0 && c > 0 && a > c) {
                                var m = function (a) {
                                    g > 0 && ("auto" === a.widthType || "percent" === a.widthType) && (a.drawnWidth = a.drawnWidth + 1, c += 1, g--)
                                }, n = 0;
                                do n = g, b.forEach(m); while (g > 0 && g !== n)
                            }
                            c = Math.max(c, a);
                            var o = "";
                            return b.forEach(function (a) {
                                o += a.getColClassDefinition()
                            }), b.length > 0 && (b[b.length - 1].headerWidth = b[b.length - 1].drawnWidth - 30), h.colContainer.canvasWidth = parseInt(c, 10), o
                        }

                        var g = e[0], h = e[1], i = g.grid;
                        d.disableAnimations(b), h.header = b;
                        var j = b[0].getElementsByClassName("ui-grid-header-viewport")[0];
                        j && (h.headerViewport = j), g && g.grid.registerStyleComputation({priority: 5, func: f})
                    }
                }
            }
        }
    ...
    angular.module("ui.grid").service("uiGridGridMenuService", ["gridUtil", "i18nService", "uiGridConstants", function (a, b, c) {
        var d = {
            initialize: function (a, b) {
                ...
                var c = [];
                return b.grid.options.gridMenuCustomItems && (angular.isArray(b.grid.options.gridMenuCustomItems) ? c = c.concat(b.grid.options.gridMenuCustomItems) : a.logError("gridOptions.gridMenuCustomItems must be an array, and is not")), c = c.concat(b.registeredMenuItems), b.grid.options.gridMenuShowHideColumns !== !1 && (c = c.concat(d.showHideColumns(b))), c
            }, showHideColumns: function (a) {
                var c = [];
                return a.grid.options.columnDefs && 0 !== a.grid.options.columnDefs.length && 0 !== a.grid.columns.length ? (c.push({title: b.getSafeText("gridMenu.columns")}), a.grid.options.gridMenuTitleFilter = a.grid.options.gridMenuTitleFilter ? a.grid.options.gridMenuTitleFilter : function (a) {
                    return a
                }, a.grid.options.columnDefs.forEach(function (b) {
                    if (b.enableHiding !== !1) {
                        var e = {
                            icon: "ui-grid-icon-ok", action: function (a) {
                        ...
                        d.setMenuItemTitle(e, b, a.grid), c.push(e), e = {
                            ...
                            context: {gridCol: a.grid.getColumn(b.name || b.field)}
                        }, d.setMenuItemTitle(e, b, a.grid), c.push(e)
                    }
                }), c) : c
            }, setMenuItemTitle: function (b, c, d) {
                var e = d.options.gridMenuTitleFilter(c.displayName || c.name || c.field);
        ...
        return d
    }]).directive("uiGridMenuButton", ["gridUtil", "uiGridConstants", "uiGridGridMenuService", function (a, b, c) {
        return {
            priority: 0,
            scope: !0,
            require: ["?^uiGrid"],
            ...
            link: function (a, b, d, e) {
                var f = e[0];
                c.initialize(a, f.grid), a.shown = !1, a.toggleMenu = function () {
                    a.shown ? (a.$broadcast("hide-menu"), a.shown = !1) : (a.menuItems = c.getMenuItems(a), a.$broadcast("show-menu"), a.shown = !0)
                }, a.$on("menu-hidden", function () {
                    a.shown = !1
                })
            }
        }
    ...
    angular.module("ui.grid").directive("uiGridMenu", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", function (a, b, c, d, e, f) {
        var g = {
            priority: 0,
            ...
            link: function (a, d, e, g) {
                var h = this;
                h.showMenu = a.showMenu = function (c, d) {
                    a.shown ? a.shownMid || (a.shownMid = !0, a.$emit("menu-shown")) : (a.shown = !0, b(function () {
                        a.shownMid = !0, a.$emit("menu-shown")
                    }));
                    var e = "click";
                    d && d.originalEvent && d.originalEvent.type && "touchstart" === d.originalEvent.type && (e = d.originalEvent.type), angular.element(document).off("click touchstart", i), b(function () {
                        angular.element(document).on(e, i)
                    })
                }, h.hideMenu = a.hideMenu = function () {
                    a.shown && (a.shownMid = !1, b(function () {
                        a.shownMid || (a.shown = !1, a.$emit("menu-hidden"))
                    }, 200)), angular.element(document).off("click touchstart", i)
                ...
                ("undefined" == typeof a.autoHide || void 0 === a.autoHide) && (a.autoHide = !0), a.autoHide && angular.element(c).on("resize", i), a.$on("$destroy", function () {
                    angular.element(document).off("click touchstart", i)
                }), a.$on("$destroy", function () {
                    angular.element(c).off("resize", i)
                }), g && a.$on("$destroy", g.grid.api.core.on.scrollEvent(a, i)), a.$on("$destroy", a.$on(f.events.ITEM_DRAGGING, i))
            },
        ...
        var d = {
            priority: 0,
            scope: {name: "=", active: "=", action: "=", icon: "=", shown: "=", context: "=", templateUrl: "="},
            ...
            compile: function () {
                return {
                    pre: function (c, d, e, f) {
                        ...
                        ("undefined" == typeof a.shown || null === a.shown) && (a.shown = function () {
                            return !0
                        }), a.itemShown = function () {
                            var b = {};
                            return a.context && (b.context = a.context), "undefined" != typeof f && f && (b.grid = f.grid), a.shown.call(b)
                        }, a.itemAction = function (b, c) {
                            if (b.stopPropagation(), "function" == typeof a.action) {
                                var d = {};
                                a.context && (d.context = a.context), "undefined" != typeof f && f && (d.grid = f.grid), a.action.call(d, b, c), a.$emit("hide-menu")
                            }
                        }, a.i18n = c.get()
                    }
                }
            ...
            compile: function () {
                return {
                    pre: function (a, b, c, d) {
                        ...
                        var h = a.rowContainer = g.renderContainers[a.rowContainerName], i = a.colContainer = g.renderContainers[a.colContainerName];
                        f.containerId = a.containerId, f.rowContainer = h, f.colContainer = i
                    }, post: function (a, b, c, f) {
                        function g(b) {
                            if (!b.grid || b.grid.id === k.id) {
                                if (b.y && a.bindScrollVertical) {
                                    j.prevScrollArgs = b;
                                    var c = b.getNewScrollTop(l, j.viewport);
                                    (b.source !== e.Sources.ViewPortScroll || b.sourceColContainer !== m) && (j.viewport[0].scrollTop = c)
                                }
                                if (b.x && a.bindScrollHorizontal) {
                                    j.prevScrollArgs = b;
                                    var f = b.getNewScrollLeft(m, j.viewport);
                                    a.newScrollLeft = f, j.headerViewport && (j.headerViewport.scrollLeft = d.denormalizeScrollLeft(j.headerViewport, f)), j.footerViewport && (j.footerViewport.scrollLeft = d.denormalizeScrollLeft(j.footerViewport, f)), b.source !== e.Sources.ViewPortScroll && (j.viewport[0].scrollLeft = f), j.prevScrollLeft = f
                                }
                            }
                        }

                        function h() {
                            var b = "", c = m.getCanvasWidth(), d = m.getViewportWidth(), e = l.getCanvasHeight();
                            "body" !== a.containerId && (e += k.scrollbarHeight);
                            var f = l.getViewportHeight(), g = m.getHeaderViewportWidth(), h = m.getHeaderViewportWidth();
                            return b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-canvas { width: " + c + "px; height: " + e + "px; }", b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-canvas { width: " + (c + k.scrollbarWidth) + "px; }", n.explicitHeaderCanvasHeight && (b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-canvas { height: " + n.explicitHeaderCanvasHeight + "px; }"), b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-viewport { width: " + d + "px; height: " + f + "px; }", b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-header-viewport { width: " + g + "px; }", b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-footer-canvas { width: " + c + k.scrollbarWidth + "px; }", b += "\n .grid" + i.grid.id + " .ui-grid-render-container-" + a.containerId + " .ui-grid-footer-viewport { width: " + h + "px; }"
                        }

                        var i = f[0], j = f[1], k = i.grid, l = j.rowContainer, m = j.colContainer, n = k.renderContainers[a.containerId];
                        b.addClass("ui-grid-render-container-" + a.containerId), (a.bindScrollHorizontal || a.bindScrollVertical) && k.api.core.on.scrollEvent(a, g), d.on.mousewheel(b, function (a) {
                            var b = new e(k, l, m, e.Sources.RenderContainerMouseWheel);
                            if (0 !== a.deltaY) {
                                var c = -1 * a.deltaY * a.deltaFactor, f = (j.viewport[0].scrollTop + c) / l.getVerticalScrollLength();
                                0 > f ? f = 0 : f > 1 && (f = 1), b.y = {percentage: f, pixels: c}
                            }
                            if (0 !== a.deltaX) {
                                var g = a.deltaX * a.deltaFactor, h = d.normalizeScrollLeft(j.viewport), i = (h + g) / (m.getCanvasWidth() - m.getViewportWidth());
                                0 > i ? i = 0 : i > 1 && (i = 1), b.x = {percentage: i, pixels: g}
                            }
                            (b.y && 0 !== b.y.percentage && 1 !== b.y.percentage || b.x && 0 !== b.x.percentage && 1 !== b.x.percentage) && (a.preventDefault(), b.fireThrottledScrollingEvent())
                        }), b.bind("$destroy", function () {
                        ...
                        }), i.grid.registerStyleComputation({priority: 6, func: h})
                    }
                }
            }
        }
    }]), a.controller("uiGridRenderContainer", ["$scope", "gridUtil", function () {
    }])
}(), function () {
    "use strict";
    angular.module("ui.grid").directive("uiGridRow", ["gridUtil", function () {
        return {
            replace: !0,
            require: ["^uiGrid", "^uiGridRenderContainer"],
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridViewport", ["gridUtil", "ScrollEvent", "uiGridConstants", function (a, b, c) {
        return {
            replace: !0,
            scope: {},
            ...
            link: function (d, e, f, g) {
                var h = g[0], i = g[1];
                d.containerCtrl = i;
                var j = i.rowContainer, k = i.colContainer, l = h.grid;
                d.grid = h.grid, d.rowContainer = i.rowContainer, d.colContainer = i.colContainer, i.viewport = e, e.on("scroll", function () {
                    var d = e[0].scrollTop, f = a.normalizeScrollLeft(e), g = -1, h = -1;
                    if (f !== k.prevScrollLeft) {
                        l.flagScrollingHorizontally();
                        var i = f - k.prevScrollLeft;
                        i > 0 && (l.scrollDirection = c.scrollDirection.RIGHT), 0 > i && (l.scrollDirection = c.scrollDirection.LEFT);
                        var m = k.getCanvasWidth() - k.getViewportWidth();
                        g = 0 !== m ? f / m : 0, k.adjustScrollHorizontal(f, g)
                    }
                    if (d !== j.prevScrollTop) {
                        l.flagScrollingVertically();
                        var n = d - j.prevScrollTop;
                        n > 0 && (l.scrollDirection = c.scrollDirection.DOWN), 0 > n && (l.scrollDirection = c.scrollDirection.UP);
                        var o = j.getVerticalScrollLength();
                        h = d / o, h > 1 && (h = 1), 0 > h && (h = 0), j.adjustScrollVertical(d, h)
                    }
                    var p = new b(l, j, k, b.Sources.ViewPortScroll);
                    p.newScrollLeft = f, p.newScrollTop = d, g > -1 && (p.x = {percentage: g}), h > -1 && (p.y = {percentage: h}), p.fireScrollingEvent()
                })
            },
            controller: ["$scope", function (a) {
    ...
    "use strict";
    angular.module("ui.grid").controller("uiGridController", ["$scope", "$element", "$attrs", "gridUtil", "$q", "uiGridConstants", "$templateCache", "gridClassFactory", "$timeout", "$parse", "$compile", "ScrollEvent", function (a, b, c, d, e, f, g, h, i, j, k, l) {
        function m(a, b) {
            a && a !== b && (p.grid.options.columnDefs = a, p.grid.buildColumns({orderByColumnDefs: !0}).then(function () {
                p.grid.preCompileCellTemplates(), p.grid.callDataChangeCallbacks(f.dataChange.COLUMN)
            }))
        }

        function n(a) {
            var b = new l(p.grid, null, null, "ui.grid.adjustInfiniteScrollPosition"), c = p.grid.renderContainers.body.visibleRowCache.length, d = (a + a / (c - 1)) / c;
            b.y = 0 === d ? {pixels: 1} : {percentage: d}, b.fireScrollingEvent()
        }

        function o(b) {
            var d = [];
            b && (p.grid.columns.length === (p.grid.rowHeaderColumns ? p.grid.rowHeaderColumns.length : 0) && !c.uiGridColumns && 0 === p.grid.options.columnDefs.length && b.length > 0 && p.grid.buildColumnDefsFromData(b), (p.grid.options.columnDefs.length > 0 || b.length > 0) && d.push(p.grid.buildColumns().then(function () {
                p.grid.preCompileCellTemplates()
            })), e.all(d).then(function () {
                p.grid.modifyRows(b).then(function () {
                    p.grid.redrawInPlace(!0), a.$evalAsync(function () {
                        p.grid.refreshCanvas(!0), p.grid.callDataChangeCallbacks(f.dataChange.ROW), i(function () {
                            p.grid.options.enableInfiniteScroll && (0 === p.grid.renderContainers.body.prevRowScrollIndex && n(0), p.grid.scrollDirection === f.scrollDirection.UP && n(p.grid.renderContainers.body.prevRowScrollIndex + 1 + p.grid.options.excessRows))
                        }, 0)
                    })
                })
            }))
        ...
        var p = this;
        p.grid = h.createGrid(a.uiGrid), p.grid.appScope = p.grid.appScope || a.$parent, b.addClass("grid" + p.grid.id), p.grid.rtl = "rtl" === d.getStyles(b[0]).direction, a.grid = p.grid, c.uiGridColumns && c.$observe("uiGridColumns", function (a) {
            p.grid.options.columnDefs = a, p.grid.buildColumns().then(function () {
                p.grid.preCompileCellTemplates(), p.grid.refreshCanvas(!0)
            })
        });
        var q;
        q = angular.isString(a.uiGrid.data) ? a.$parent.$watchCollection(a.uiGrid.data, o) : a.$parent.$watchCollection(function () {
            return a.uiGrid.data
        }, o);
        var r = a.$parent.$watchCollection(function () {
            return a.uiGrid.columnDefs
        }, m), s = a.$watch(function () {
            return p.grid.styleComputations
        }, function () {
            p.grid.refreshCanvas(!0)
        });
        a.$on("$destroy", function () {
            q(), r(), s()
        }), p.fireEvent = function (b, c) {
            ("undefined" == typeof c || void 0 === c) && (c = {}), ("undefined" == typeof c.grid || void 0 === c.grid) && (c.grid = p.grid), a.$broadcast(b, c)
        }, p.innerCompile = function (b) {
            k(b)(a)
        }
    }]), angular.module("ui.grid").directive("uiGrid", ["$compile", "$templateCache", "gridUtil", "$window", "uiGridConstants", function (a, b, c, d, e) {
        return {
            ...
            compile: function () {
                return {
                    post: function (a, b, f, g) {
                        function h() {
                            i.gridWidth = a.gridWidth = c.elementWidth(b), i.gridHeight = a.gridHeight = c.elementHeight(b), i.refreshCanvas(!0)
                        }

                        var i = g.grid;
                        if (g.scrollbars = [], i.renderingComplete(), i.element = b, i.gridWidth = a.gridWidth = c.elementWidth(b), i.canvasWidth = g.grid.gridWidth, i.gridHeight = a.gridHeight = c.elementHeight(b), i.gridHeight < i.options.rowHeight) {
                            var j = i.options.minRowsToShow * i.options.rowHeight, k = i.options.showHeader ? i.options.headerRowHeight : 0, l = i.calcFooterHeight(), m = 0;
                            i.options.enableHorizontalScrollbar === e.scrollbars.ALWAYS && (m = c.getScrollbarWidth());
                            var n = 0;
                            angular.forEach(i.options.columnDefs, function (a) {
                                a.hasOwnProperty("filter") ? 1 > n && (n = 1) : a.hasOwnProperty("filters") && n < a.filters.length && (n = a.filters.length)
                            });
                            var o = n * k, p = k + j + l + m + o;
                            b.css("height", p + "px"), i.gridHeight = a.gridHeight = c.elementHeight(b)
                        }
                        i.refreshCanvas(), a.$watch(function () {
                            ...
                            a !== b && i.refreshCanvas(!0)
                        }), angular.element(d).on("resize", h), b.on("$destroy", function () {
                            angular.element(d).off("resize", h)
                        })
                    }
                }
            }
    ...
    "use strict";
    angular.module("ui.grid").directive("uiGridPinnedContainer", ["gridUtil", function () {
        return {
            restrict: "EA",
            replace: !0,
                    ...
                    post: function (a, b, c, d) {
                        function e() {
                            if ("left" === a.side || "right" === a.side) {
                                for (var b = g.renderContainers[a.side].visibleColumnCache, c = 0, d = 0; d < b.length; d++) {
                                    var e = b[d];
                        ...
                        function f() {
                            ...
                            if ("left" === a.side || "right" === a.side) {
                                e(), b.attr("style", null);
                                var d = g.renderContainers.body.getViewportHeight();
                                c += ".grid" + g.id + " .ui-grid-pinned-container-" + a.side + ", .grid" + g.id + " .ui-grid-pinned-container-" + a.side + " .ui-grid-render-container-" + a.side + " .ui-grid-viewport { width: " + h + "px; height: " + d + "px; } "
                            }
                            return c
                        }

                        var g = d.grid, h = 0;
                        b.addClass("ui-grid-pinned-container-" + a.side), g.renderContainers.body.registerViewportAdjuster(function (a) {
                            return 0 !== h && h || e(), a.width -= h, a
                        }), g.registerStyleComputation({priority: 15, func: f})
                    }
                }
            }
        }
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
        function n() {
        }
        ...
        return o.prototype.calcFooterHeight = function () {
            ...
            return this.rtl
        }, o.prototype.registerColumnBuilder = function (a) {
        ...
        }, o.prototype.registerRowBuilder = function (a) {
            this.rowBuilders.push(a)
        }, o.prototype.registerDataChangeCallback = function (a, b, c) {
            var f = d.nextUid();
            ...
            return h
        }, o.prototype.callDataChangeCallbacks = function (a) {
            angular.forEach(this.dataChangeCallbacks, function (b) {
        ...
        }, o.prototype.notifyDataChange = function (a) {
            var b = e.dataChange;
        ...
        }, o.prototype.columnRefreshCallback = function (a) {
            a.buildColumns(), a.refresh()
        }, o.prototype.processRowsCallback = function (a) {
            a.refreshRows()
        }, o.prototype.getColumn = function (a) {
            var b = this.columns.filter(function (b) {
                return b.colDef.name === a
            });
            return b.length > 0 ? b[0] : null
        }, o.prototype.getColDef = function (a) {
            ...
            a.options.columnDefs.forEach(function (b, c) {
                if (!b.type) {
                    ...
                    f ? b.type = d.guessType(a.getCellValue(f, e)) : (d.logWarn("Unable to assign type from data, so defaulting to string"), b.type = "string")
                }
            })
        }, o.prototype.addRowHeaderColumn = function (a) {
            var b = this, c = new g(a, b.rowHeaderColumns.length, b);
            c.isRowHeader = !0, b.isRTL() ? (b.createRightContainer(), c.renderContainer = "right") : (b.createLeftContainer(), c.renderContainer = "left"), b.columnBuilders[0](a, c, b.options).then(function () {
                c.enableFiltering = !1, c.enableSorting = !1, c.enableHiding = !1, b.rowHeaderColumns.push(c), b.buildColumns().then(function () {
                    b.preCompileCellTemplates(), b.refresh()
                })
            })
        }, o.prototype.buildColumns = function (b) {
            ...
            if (f.rowHeaderColumns.forEach(function (a) {
                ...
                for (e = 0; e < f.options.columnDefs.length; e++)j[e + i] = f.columns[e + i].name !== f.options.columnDefs[e].name ? f.getColumn(f.options.columnDefs[e].name) : f.columns[e + i];
        ...
        }, o.prototype.preprocessColDef = function (a) {
            var b = this;
            if (!a.field && !a.name)throw new Error("colDef.name or colDef.field property is required");
            if (void 0 === a.name && void 0 !== a.field) {
                var c = b.getColumn(a.field);
                if (c) {
                    var d = new RegExp("^" + a.field + "(\\d+)$", "i"), e = b.columns.filter(function (a) {
                        return d.test(a.displayName)
                    }).sort(function (a, b) {
                        if (a === b)return 0;
                        var c = a.displayName.match(d)[1], e = b.displayName.match(d)[1];
                        return parseInt(c, 10) > parseInt(e, 10) ? 1 : -1
                    });
                    if (0 === e.length)a.name = a.field + "2"; else {
                        var f = e[e.length - 1].displayName.match(d)[1];
                        f = parseInt(f, 10), a.name = a.field + (f + 1)
                    }
                } else a.name = a.field
            }
        }, o.prototype.newInN = function (a, b, c, d) {
            ...
            return f
        }, o.prototype.getRow = function (a) {
            var b = this, c = this.rows.filter(function (c) {
                return b.options.rowEquality(c.entity, a)
            });
            return c.length > 0 ? c[0] : null
        }, o.prototype.modifyRows = function (b) {
            var c, d, e, f, g = this;
            if ((g.options.useExternalSorting || 0 === g.getColumnSorting().length) && b.length > 0) {
                var i = g.rowHashMap;
                i || (i = {
                    get: function () {
                        return null
                    }
                }), g.createRowHashMap(), d = g.rowHashMap;
                {
                    0 === g.rows.length
                }
                for (g.rows.length = 0, c = 0; c < b.length; c++) {
                    var j = b[c];
                    e = i.get(j), f = e ? e.row : g.processRowBuilders(new h(j, c, g)), g.rows.push(f), d.put(j, {
                        i: c,
                        entity: j,
                        row: f
                    })
                ...
                g.assignTypes()
            } else if (0 === g.rows.length && b.length > 0) {
                if (g.options.enableRowHashing)for (g.rowHashMap || g.createRowHashMap(), c = 0; c < b.length; c++)f = b[c], g.rowHashMap.put(f, {
                    i: c,
                    entity: f
                });
                g.addRows(b), g.assignTypes()
            } else if (b.length > 0) {
                var k, l, m;
                if (g.options.enableRowHashing) {
                    k = [], m = [];
                    var n = {};
                    for (l = [], g.rowHashMap || g.createRowHashMap(), d = g.rowHashMap, c = 0; c < b.length; c++) {
                        f = b[c];
                        var o = !1;
                        g.options.getRowIdentity(f) || (o = !0), e = d.get(f), e ? e.row && (n[g.options.rowIdentity(f)] = !0) : (d.put(f, {
                            i: c,
                            entity: f
                        }), o ? m.push(f) : k.push(f))
                    }
                    for (c = 0; c < g.rows.length; c++) {
                        var p = g.rows[c], q = g.options.rowIdentity(p.entity);
                        n[q] || l.push(p)
                    }
                }
                var r = k || [], s = m || b;
                r = r.concat(g.newInN(g.rows, s, "entity")), g.addRows(r);
                var t = g.getDeletedRows(l || g.rows, b);
                for (c = 0; c < t.length; c++)g.options.enableRowHashing && g.rowHashMap.remove(t[c].entity), g.rows.splice(g.rows.indexOf(t[c]), 1)
            } else g.createRowHashMap(), g.rows.length = 0;
            var u = a.when(g.processRowsProcessors(g.rows)).then(function (a) {
                return g.setVisibleRows(a)
            }), v = a.when(g.processColumnsProcessors(g.columns)).then(function (a) {
                return g.setVisibleColumns(a)
            });
            return a.all([u, v])
        }, o.prototype.getDeletedRows = function (a, b) {
            var c = this, d = a.filter(function (a) {
                return !b.some(function (b) {
                    return c.options.rowEquality(b, a.entity)
                })
            });
            return d
        }, o.prototype.addRows = function (a) {
        ...
        }, o.prototype.processRowBuilders = function (a) {
            var b = this;
            return b.rowBuilders.forEach(function (c) {
                c.call(b, a, b.options)
            }), a
        }, o.prototype.registerStyleComputation = function (a) {
            this.styleComputations.push(a)
        }, o.prototype.registerRowsProcessor = function (a) {
            if (!angular.isFunction(a))throw"Attempt to register non-function rows processor: " + a;
            this.rowsProcessors.push(a)
        }, o.prototype.removeRowsProcessor = function (a) {
            var b = this.rowsProcessors.indexOf(a);
            "undefined" != typeof b && void 0 !== b && this.rowsProcessors.splice(b, 1)
        }, o.prototype.processRowsProcessors = function (b) {
            function c(b, e) {
                var g = d.rowsProcessors[b];
        ...
        }, o.prototype.setVisibleRows = function (a) {
            var b = this;
            ...
            for (var e = 0; e < a.length; e++) {
                var f = a[e];
                f.visible && ("undefined" != typeof f.renderContainer && f.renderContainer ? b.renderContainers[f.renderContainer].visibleRowCache.push(f) : b.renderContainers.body.visibleRowCache.push(f))
            }
            b.api.core.raise.rowsRendered(this.api)
        }, o.prototype.registerColumnsProcessor = function (a) {
            if (!angular.isFunction(a))throw"Attempt to register non-function rows processor: " + a;
            this.columnsProcessors.push(a)
        }, o.prototype.removeColumnsProcessor = function (a) {
            var b = this.columnsProcessors.indexOf(a);
            "undefined" != typeof b && void 0 !== b && this.columnsProcessors.splice(b, 1)
        }, o.prototype.processColumnsProcessors = function (b) {
            function c(b, g) {
                var h = d.columnsProcessors[b];
            ...
            var f = a.defer();
            return c(0, e), f.promise
        }, o.prototype.setVisibleColumns = function (a) {
            var b = this;
            for (var c in b.renderContainers) {
                var d = b.renderContainers[c];
        ...
        }, o.prototype.handleWindowResize = function () {
            var a = this;
            a.gridWidth = d.elementWidth(a.element), a.gridHeight = d.elementHeight(a.element), a.queueRefresh()
            ...
            return a
        }, o.prototype.registerViewportAdjuster = function (a) {
            this.viewportAdjusters.push(a)
        }, o.prototype.removeViewportAdjuster = function (a) {
        ...
        }, o.prototype.searchRows = function (a) {
            return k.search(this, a, this.columns)
        }, o.prototype.sortByColumn = function (a) {
            return j.sort(this, a, this.columns)
        }, o.prototype.getCellValue = function (a, b) {
            var d = this;
            return d.cellValueGetterCache[b.colDef.name] || (d.cellValueGetterCache[b.colDef.name] = c(a.getEntityQualifiedColField(b))), d.cellValueGetterCache[b.colDef.name](a)
        ...
        }, o.prototype.resetColumnSorting = function (a) {
            var b = this;
            b.columns.forEach(function (b) {
                b === a || b.colDef.suppressRemoveSort || (b.sort = {})
            })
            ...
            var a = this, b = new n;
            b.grid = a, a.rowHashMap = b
        }, o.prototype.refresh = function (b) {
            ...
            for (var g in c.renderContainers)if (c.renderContainers.hasOwnProperty(g)) {
                ...
                (h.header || h.headerCanvas) && f.push(h)
            }
            return m(f.length > 0 ? function () {
                var a, g, h = !1, i = 0, j = 0;
                for (a = 0; a < f.length; a++)if (g = f[a], null !== g.canvasWidth && !isNaN(g.canvasWidth)) {
                    if (g.header) {
                        var k = g.headerHeight, l = d.outerElementHeight(g.header);
                        g.headerHeight = parseInt(l, 10), k !== l && (h = !0);
                        var m = d.getBorderSize(g.header, "top"), n = d.getBorderSize(g.header, "bottom"), o = parseInt(l - m - n, 10);
                        o = 0 > o ? 0 : o, g.innerHeaderHeight = o, o > i && (i = o)
                    }
                    if (g.headerCanvas) {
                        var p = g.headerCanvasHeight, q = d.outerElementHeight(g.headerCanvas);
                        g.headerCanvasHeight = parseInt(q, 10), p !== q && (h = !0), q > j && (j = q)
                    }
                }
                for (a = 0; a < f.length; a++)g = f[a], i > 0 && "undefined" != typeof g.headerHeight && null !== g.headerHeight && g.headerHeight < i && (g.explicitHeaderHeight = i), "undefined" != typeof g.headerCanvasHeight && null !== g.headerCanvasHeight && j > 0 && g.headerCanvasHeight < j && (g.explicitHeaderCanvasHeight = j);
                b && h && c.buildStyles(), e.resolve()
            } : function () {
                e.resolve()
            }), e.promise
        }, o.prototype.redrawInPlace = function (a) {
            var b = this;
            for (var c in b.renderContainers) {
                var d = b.renderContainers[c];
                a ? (d.adjustRows(d.prevScrollTop, null), d.adjustColumns(d.prevScrollTop, null)) : (d.adjustRows(null, d.prevScrolltopPercentage), d.adjustColumns(null, d.prevScrollleftPercentage))
            }
    ...
    angular.module("ui.grid").factory("GridApi", ["$q", "$rootScope", "gridUtil", "uiGridConstants", "GridRow", "uiGridGridMenuService", function (a, b, c, d, e) {
        function f(a, c, d, e) {
            return b.$on(a, function () {
                var a = Array.prototype.slice.call(arguments);
                a.splice(0, 1), c.apply(e ? e : d.api, a)
            })
        }

        var g = function (a) {
            this.grid = a, this.listeners = [], this.registerEvent("core", "renderingComplete"), this.registerEvent("core", "filterChanged"), this.registerMethod("core", "setRowInvisible", e.prototype.setRowInvisible), this.registerMethod("core", "clearRowInvisible", e.prototype.clearRowInvisible), this.registerMethod("core", "getVisibleRows", this.grid.getVisibleRows), this.registerEvent("core", "rowsVisibleChanged"), this.registerEvent("core", "rowsRendered"), this.registerEvent("core", "scrollEvent"), this.registerEvent("core", "canvasHeightChanged")
        };
        return g.prototype.suppressEvents = function (a, b) {
            var c = this, d = angular.isArray(a) ? a : [a], e = [];
            d.forEach(function (a) {
                e = c.listeners.filter(function (b) {
                    return a === b.handler
                })
            }), e.forEach(function (a) {
                a.dereg()
            }), b(), e.forEach(function (a) {
                a.dereg = f(a.eventId, a.handler, c.grid, a._this)
            })
        }, g.prototype.registerEvent = function (a, c) {
            var d = this;
            d[a] || (d[a] = {});
            var e = d[a];
            e.on || (e.on = {}, e.raise = {});
            var g = d.grid.id + a + c;
            e.raise[c] = function () {
                b.$emit.apply(b, [g].concat(Array.prototype.slice.call(arguments)))
            }, e.on[c] = function (a, b, c) {
                var e = f(g, b, d.grid, c), h = {handler: b, dereg: e, eventId: g, scope: a, _this: c};
                d.listeners.push(h);
                var i = function () {
                    h.dereg();
                    var a = d.listeners.indexOf(h);
                    d.listeners.splice(a, 1)
                };
    ...
    angular.module("ui.grid").factory("GridColumn", ["gridUtil", "uiGridConstants", "i18nService", function (a, b, c) {
        function d(a, b, c) {
            var d = this;
            d.grid = c, d.uid = b, d.updateColumnDef(a, !0)
        }

        return d.prototype.setPropertyOrDefault = function (a, b, c) {
            var d = this;
            d[b] = "undefined" != typeof a[b] && a[b] ? a[b] : "undefined" != typeof d[b] ? d[b] : c ? c : {}
            ...
            var f = "Cannot parse column width '" + b.width + "' for column named '" + b.name + "'";
            if (a.isNullOrUndefined(e.width) || !angular.isNumber(e.width))if (a.isNullOrUndefined(b.width))e.width = "*"; else if (angular.isNumber(b.width))e.width = b.width; else if (a.endsWith(b.width, "%")) {
                var g = b.width.replace(/%/g, ""), h = parseInt(g, 10);
                if (isNaN(h))throw new Error(f);
                e.width = b.width
            } else if (b.width.match(/^(\d+)$/))e.width = parseInt(b.width.match(/^(\d+)$/)[1], 10); else {
                if (!b.width.match(/^\*+$/))throw new Error(f);
                e.width = b.width
            }
            e.minWidth = b.minWidth ? b.minWidth : 30, e.maxWidth = b.maxWidth ? b.maxWidth : 9e3, e.field = void 0 === b.field ? b.name : b.field, "string" != typeof e.field && a.logError("Field is not a string, this is likely to break the code, Field is: " + e.field), e.name = b.name, e.displayName = void 0 === b.displayName ? a.readableColumnName(b.name) : b.displayName, e.aggregationType = angular.isDefined(b.aggregationType) ? b.aggregationType : null, e.footerCellTemplate = angular.isDefined(b.footerCellTemplate) ? b.footerCellTemplate : null, e.footerCellClass = b.footerCellClass, e.cellClass = b.cellClass, e.headerCellClass = b.headerCellClass, e.cellFilter = b.cellFilter ? b.cellFilter : "", e.headerCellFilter = b.headerCellFilter ? b.headerCellFilter : "", e.footerCellFilter = b.footerCellFilter ? b.footerCellFilter : "", e.visible = a.isNullOrUndefined(b.visible) || b.visible, e.headerClass = b.headerClass, e.enableSorting = "undefined" != typeof b.enableSorting ? b.enableSorting : !0, e.sortingAlgorithm = b.sortingAlgorithm, e.enableFiltering = "undefined" != typeof b.enableFiltering ? b.enableFiltering : !0, e.setPropertyOrDefault(b, "menuItems", []), c && e.setPropertyOrDefault(b, "sort");
            var i = [];
            b.filter ? i.push(b.filter) : e.enableFiltering && e.grid.options.enableFiltering && i.push({}), c && (e.setPropertyOrDefault(b, "filter"), e.setPropertyOrDefault(b, "filters", i)), d.prototype.unsort = function () {
                this.sort = {}, e.grid.api.core.raise.sortChanged(e, e.grid.getColumnSorting())
            }
        ...
        }, d.prototype.getAggregationValue = function () {
            var a = this, c = 0, d = a.grid.getVisibleRows(), e = function () {
                var b = [];
                return angular.forEach(d, function (c) {
                    var d = a.grid.getCellValue(c, a);
                    angular.isNumber(d) && b.push(d)
                }), b
            };
            return angular.isFunction(a.aggregationType) ? a.aggregationType(d, a) : a.aggregationType === b.aggregationTypes.count ? a.grid.getVisibleRowCount() : a.aggregationType === b.aggregationTypes.sum ? (angular.forEach(e(), function (a) {
                c += a
            }), c) : a.aggregationType === b.aggregationTypes.avg ? (angular.forEach(e(), function (a) {
                c += a
            }), c /= e().length) : a.aggregationType === b.aggregationTypes.min ? Math.min.apply(null, e()) : a.aggregationType === b.aggregationTypes.max ? Math.max.apply(null, e()) : " "
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function (a, b) {
        function c(a, b, c) {
            var d = this;
            d.name = a, d.grid = b, d.visibleRowCache = [], d.visibleColumnCache = [], d.renderedRows = [], d.renderedColumns = [], d.prevScrollTop = 0, d.prevScrolltopPercentage = 0, d.prevRowScrollIndex = 0, d.prevScrollLeft = 0, d.prevScrollleftPercentage = 0, d.prevColumnScrollIndex = 0, d.columnStyles = "", d.viewportAdjusters = [], d.canvasHeightShouldUpdate = !0, d.$$canvasHeight = 0, c && angular.isObject(c) && angular.extend(d, c), b.registerStyleComputation({
                priority: 5,
                func: function () {
                    return d.columnStyles
                }
            })
        }
        ...
        return c.prototype.reset = function () {
            ...
            var a = this, b = a.headerHeight ? a.headerHeight : a.grid.headerHeight, c = a.grid.gridHeight - b - a.grid.footerHeight, d = a.getViewportAdjustment();
            return c += d.height
            ...
            (this.prevScrollTop !== a || c) && (("undefined" == typeof a || void 0 === a || null === a) && (a = (this.getCanvasHeight() - this.getCanvasWidth()) * b), this.adjustRows(a, b, !1), this.prevScrollTop = a, this.prevScrolltopPercentage = b, this.grid.queueRefresh())
        ...
        }, c.prototype.adjustRows = function (a, c, d) {
            var e = this, f = e.minRowsToRender(), g = e.visibleRowCache, h = g.length - f;
            "undefined" != typeof c && null !== c || !a || (c = a / e.getVerticalScrollLength());
            var i = Math.ceil(Math.min(h, h * c));
            i > h && (i = h);
            var j = [];
            if (g.length > e.grid.options.virtualizationThreshold) {
                if ("undefined" != typeof a && null !== a) {
                    if (!e.grid.options.enableInfiniteScroll && e.prevScrollTop < a && i < e.prevRowScrollIndex + e.grid.options.scrollThreshold && h > i)return;
                    if (!e.grid.options.enableInfiniteScroll && e.prevScrollTop > a && i > e.prevRowScrollIndex - e.grid.options.scrollThreshold && h > i)return
                }
                var k = {}, l = {};
                if (e.grid.options.enableInfiniteScroll && e.grid.scrollDirection !== b.scrollDirection.NONE && d) {
                    var m = null, n = null;
                    if (e.grid.scrollDirection === b.scrollDirection.UP) {
                        for (m = i > 0 ? e.grid.options.excessRows : 0, n = 0; n < g.length; n++)if (g[n].entity.$$hashKey === e.renderedRows[m].entity.$$hashKey) {
                            i = n;
                            break
                        }
                        k = Math.max(0, i), l = Math.min(g.length, k + e.grid.options.excessRows + f)
                    } else if (e.grid.scrollDirection === b.scrollDirection.DOWN) {
                        for (m = f, n = 0; n < g.length; n++)if (g[n].entity.$$hashKey === e.renderedRows[m].entity.$$hashKey) {
                            i = n;
                            break
                        }
                        k = Math.max(0, i - e.grid.options.excessRows - f), l = Math.min(g.length, i + f + e.grid.options.excessRows)
                    }
                } else k = Math.max(0, i - e.grid.options.excessRows), l = Math.min(g.length, i + f + e.grid.options.excessRows);
                j = [k, l]
            } else {
                var o = e.visibleRowCache.length;
                j = [0, Math.max(o, f + e.grid.options.excessRows)]
            }
            ...
            if (e.length > c.grid.options.columnVirtualizationThreshold && c.getCanvasWidth() > c.getViewportWidth()) {
                var i = Math.max(0, g - c.grid.options.excessColumns), j = Math.min(e.length, g + d + c.grid.options.excessColumns);
                h = [i, j]
            } else {
            ...
            var b, c = this, d = [], e = [], f = 0, g = c.getViewportWidth() - c.grid.scrollbarWidth, h = 0, i = 0, j = "", k = c.visibleColumnCache;
            k.forEach(function (b) {
                if (b.visible) {
                    var c = !1;
                    angular.isNumber(b.width) || (c = isNaN(b.width) && a.endsWith(b.width, "%")), angular.isString(b.width) && -1 !== b.width.indexOf("*") ? (f = parseInt(f + b.width.length, 10), d.push(b)) : c ? e.push(b) : angular.isNumber(b.width) && (h = parseInt(h + b.width, 10), i = parseInt(i, 10) + parseInt(b.width, 10), b.drawnWidth = b.width)
                }
            });
            var l, m, n, o = g - h;
            if (e.length > 0) {
                for (l = 0; l < e.length; l++) {
                    m = e[l];
                    var p = parseInt(m.width.replace(/%/g, ""), 10) / 100;
                    n = parseInt(p * o, 10), m.colDef.minWidth && n < m.colDef.minWidth ? (n = m.colDef.minWidth, o -= n, i += n, m.drawnWidth = n, e.splice(l, 1)) : m.colDef.maxWidth && n > m.colDef.maxWidth && (n = m.colDef.maxWidth, o -= n, i += n, m.drawnWidth = n, e.splice(l, 1))
                }
                e.forEach(function (a) {
                    var b = parseInt(a.width.replace(/%/g, ""), 10) / 100, c = parseInt(b * o, 10);
                    i += c, a.drawnWidth = c
                })
            }
            if (d.length > 0) {
                var q = parseInt(o / f, 10);
                for (l = 0; l < d.length; l++)m = d[l], n = parseInt(q * m.width.length, 10), m.colDef.minWidth && n < m.colDef.minWidth ? (n = m.colDef.minWidth, o -= n, f--, i += n, m.drawnWidth = n, b = m, d.splice(l, 1)) : m.colDef.maxWidth && n > m.colDef.maxWidth && (n = m.colDef.maxWidth, o -= n, f--, i += n, m.drawnWidth = n, d.splice(l, 1));
                q = parseInt(o / f, 10), d.forEach(function (a) {
                    var b = parseInt(q * a.width.length, 10);
                    i += b, a.drawnWidth = b
                })
            }
            var r = g - parseInt(i, 10);
            if (r > 0 && i > 0 && g > i) {
                var s = !1;
                if (k.forEach(function (a) {
                        a.width && !angular.isNumber(a.width) && (s = !0)
                    }), s)for (var t = function (a) {
                    r > 0 && (a.drawnWidth = a.drawnWidth + 1, i += 1, r--)
                }; r > 0;)k.forEach(t)
            }
            g > i && (i = g), k.forEach(function (a) {
                j += a.getColClassDefinition()
            }), c.canvasWidth = parseInt(i, 10), this.columnStyles = j
        }, c.prototype.getViewPortStyle = function () {
            var a = this, c = {};
            return "body" === a.name ? (c["overflow-x"] = a.grid.options.enableHorizontalScrollbar === b.scrollbars.NEVER ? "hidden" : "scroll", c["overflow-y"] = a.grid.isRTL() ? a.grid.hasLeftContainerColumns() ? "hidden" : a.grid.options.enableVerticalScrollbar === b.scrollbars.NEVER ? "hidden" : "scroll" : a.grid.hasRightContainerColumns() ? "hidden" : a.grid.options.enableVerticalScrollbar === b.scrollbars.NEVER ? "hidden" : "scroll") : "left" === a.name ? (c["overflow-x"] = "hidden", c["overflow-y"] = a.grid.isRTL() ? a.grid.options.enableVerticalScrollbar === b.scrollbars.NEVER ? "hidden" : "scroll" : "hidden") : (c["overflow-x"] = "hidden", c["overflow-y"] = a.grid.isRTL() ? "hidden" : a.grid.options.enableVerticalScrollbar === b.scrollbars.NEVER ? "hidden" : "scroll"), c
        }, c
    }])
}(), function () {
    angular.module("ui.grid").factory("GridRow", ["gridUtil", function (a) {
        ...
        return Object.defineProperty(b.prototype, "height", {
            ...
            null !== a && (a.forceInvisible = !0, a.visible && (a.visible = !1, a.grid.refresh(), a.grid.api.core.raise.rowsVisibleChanged()))
        }, b.prototype.clearRowInvisible = function (a) {
            null !== a && (a.forceInvisible = !1, a.visible || (a.visible = !0, a.grid.refresh(), a.grid.api.core.raise.rowsVisibleChanged()))
        }, b
    }])
}(), function () {
    angular.module("ui.grid").factory("ScrollEvent", ["gridUtil", function (a) {
        function b(b, c, d, e) {
            ...
            f.grid = b, f.source = e, f.sourceRowContainer = c, f.sourceColContainer = d, f.newScrollLeft = null, f.newScrollTop = null, f.x = null, f.y = null, f.fireThrottledScrollingEvent = a.throttle(function () {
                f.grid.api.core.raise.scrollEvent(f)
            }, f.grid.options.scrollThrottle, {trailing: !0})
        }

        return b.prototype.fireScrollingEvent = function () {
            this.grid.api.core.raise.scrollEvent(this)
        }, b.prototype.getNewScrollLeft = function (b, c) {
            var d = this;
            if (!d.newScrollLeft) {
                var e, f = b.getCanvasWidth() - b.getViewportWidth(), g = a.normalizeScrollLeft(c);
    ...
    "use strict";
    angular.module("ui.grid").service("gridClassFactory", ["gridUtil", "$q", "$compile", "$templateCache", "uiGridConstants", "Grid", "GridColumn", "GridRow", function (a, b, c, d, e, f) {
        var g = {
            createGrid: function (d) {
                ...
                if (e.options.rowTemplate) {
                    var h = b.defer();
                    e.getRowTemplateFn = h.promise, a.getTemplate(e.options.rowTemplate).then(function (a) {
                        var b = c(a);
                        h.resolve(b)
                    }, function () {
                ...
                return e.registerColumnBuilder(g.defaultColumnBuilder), e.registerRowBuilder(g.rowTemplateAssigner), e.registerRowsProcessor(function (a) {
                    return a.forEach(function (a) {
                        a.visible = !a.forceInvisible
                    }), a
                ...
                }), e.options.enableFiltering && e.registerRowsProcessor(e.searchRows), e.registerRowsProcessor(e.options.externalSort && angular.isFunction(e.options.externalSort) ? e.options.externalSort : e.sortByColumn), e
            }, defaultColumnBuilder: function (c, d) {
                var f = [];
                return d.providedHeaderCellTemplate = c.headerCellTemplate ? c.headerCellTemplate : "ui-grid/uiGridHeaderCell", d.providedCellTemplate = c.cellTemplate ? c.cellTemplate : "ui-grid/uiGridCell", d.providedFooterCellTemplate = c.footerCellTemplate ? c.footerCellTemplate : "ui-grid/uiGridFooterCell", d.cellTemplatePromise = a.getTemplate(d.providedCellTemplate), f.push(d.cellTemplatePromise.then(function (a) {
                    d.cellTemplate = a.replace(e.CUSTOM_FILTERS, d.cellFilter ? "|" + d.cellFilter : "")
                }, function () {
                    throw new Error("Couldn't fetch/use colDef.cellTemplate '" + c.cellTemplate + "'")
                })), f.push(a.getTemplate(d.providedHeaderCellTemplate).then(function (a) {
                    d.headerCellTemplate = a.replace(e.CUSTOM_FILTERS, d.headerCellFilter ? "|" + d.headerCellFilter : "")
                }, function () {
                    throw new Error("Couldn't fetch/use colDef.headerCellTemplate '" + c.headerCellTemplate + "'")
                })), f.push(a.getTemplate(d.providedFooterCellTemplate).then(function (a) {
                    d.footerCellTemplate = a.replace(e.CUSTOM_FILTERS, d.footerCellFilter ? "|" + d.footerCellFilter : "")
                }, function () {
                    throw new Error("Couldn't fetch/use colDef.footerCellTemplate '" + c.footerCellTemplate + "'")
                })), d.compiledElementFnDefer = b.defer(), b.all(f)
    ...
    b.service("rowSearcher", ["gridUtil", "uiGridConstants", function (b, c) {
        ...
        return e.getTerm = function (a) {
            ...
            for (var b = [], d = a.length, f = 0; d > f; f++) {
                var g = a[f];
                if (g.noTerm || g.term) {
                    var h = {}, i = "";
                    g.flags && g.flags.caseSensitive || (i += "i"), g.term && (h.term = e.stripTerm(g)), h.condition = g.condition ? g.condition : e.guessCondition(g), h.flags = angular.extend({
                        caseSensitive: !1,
                        date: !1
                    }, g.flags), h.condition === c.filter.STARTS_WITH && (h.startswithRE = new RegExp("^" + h.term, i)), h.condition === c.filter.ENDS_WITH && (h.endswithRE = new RegExp(h.term + "$", i)), h.condition === c.filter.CONTAINS && (h.containsRE = new RegExp(h.term, i)), h.condition === c.filter.EXACT && (h.exactRE = new RegExp("^" + h.term + "$", i)), b.push(h)
                }
            }
            return b
        }, e.runColumnFilter = function (a, b, d, e) {
            var f = typeof e.condition, g = e.term, h = a.getCellValue(b, d);
            if (e.condition instanceof RegExp)return e.condition.test(h);
            if ("function" === f)return e.condition(g, h, b, d);
            if (e.startswithRE)return e.startswithRE.test(h);
            if (e.endswithRE)return e.endswithRE.test(h);
            if (e.containsRE)return e.containsRE.test(h);
            if (e.exactRE)return e.exactRE.test(h);
            ...
            return e.flags.date === !0 && (h = new Date(h), g = new Date(g.replace(/\\/g, ""))), e.condition === c.filter.GREATER_THAN ? h > g : e.condition === c.filter.GREATER_THAN_OR_EQUAL ? h >= g : e.condition === c.filter.LESS_THAN ? g > h : e.condition === c.filter.LESS_THAN_OR_EQUAL ? g >= h : !0
        }, e.searchColumn = function (a, b, c, d) {
            if (a.options.useExternalFiltering)return !0;
            for (var f = d.length, g = 0; f > g; g++) {
                var h = d[g], i = e.runColumnFilter(a, b, c, h);
                if (!i)return !1
            }
            return !0
        }, e.search = function (a, b, c) {
            if (b) {
                for (var d = [], f = c.length, g = 0; f > g; g++) {
                    var h = c[g];
                    "undefined" != typeof h.filters && (h.filters.length > 1 || 1 === h.filters.length && ("undefined" != typeof h.filters[0].term && h.filters[0].term || h.filters[0].noTerm)) ? d.push({
                        col: h,
                        filters: e.setupFilters(h.filters)
                    }) : "undefined" != typeof h.filter && h.filter && ("undefined" != typeof h.filter.term && h.filter.term || h.filter.noTerm) && d.push({
                        col: h,
                        filters: e.setupFilters([h.filter])
                    })
                }
                if (d.length > 0) {
                    for (var i = function (a, b, c, d) {
                        (b.forceInvisible || !e.searchColumn(a, b, c, d)) && (b.visible = !1)
                    }, j = function (a, c) {
                        for (var d = b.length, e = 0; d > e; e++)i(a, b[e], c.col, c.filters)
                    }, k = d.length, l = 0; k > l; l++)j(a, d[l]);
    ...
    a.service("rowSorter", ["$parse", "uiGridConstants", function (a, b) {
        ...
        return d.guessSortFn = function (a) {
        ...
        }, d.getSortFn = function (a, b) {
            var c;
            return d.colSortFnCache[b.colDef.name] ? c = d.colSortFnCache[b.colDef.name] : void 0 !== b.sortingAlgorithm ? (c = b.sortingAlgorithm, d.colSortFnCache[b.colDef.name] = b.sortingAlgorithm) : (c = d.guessSortFn(b.colDef.type), c ? d.colSortFnCache[b.colDef.name] = c : c = d.sortAlpha), c
            ...
            if (c) {
                ...
                if (e.forEach(function (a) {
                        a.sort && a.sort.direction && (a.sort.direction === b.ASC || a.sort.direction === b.DESC) && f.push(a)
                    }), f = f.sort(d.prioritySort), 0 === f.length)return c;
                var g, h, i = c.slice(0);
                angular.forEach(c, function (a, b) {
                    a.entity.$uiGridIndex = b
                });
                var j = c.sort(function (c, e) {
                    for (var j, k = 0, l = 0; 0 === k && l < f.length;) {
                        g = f[l], h = f[l].sort.direction, j = d.getSortFn(a, g, i);
                        var m = a.getCellValue(c, g), n = a.getCellValue(e, g);
                        k = j(m, n), l++
                    }
                    return 0 === k ? c.entity.$uiGridIndex - e.entity.$uiGridIndex : h === b.ASC ? k : 0 - k
                });
                return angular.forEach(j, function (a) {
    ...
    var g = new RegExp("^(" + /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source + ")(?!px)[a-z%]+$", "i"), h = /^(block|none|table(?!-c[ea]).+)/, i = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, j = ["0", "0", "0"], k = "uiGrid-";
    f.service("gridUtil", ["$log", "$window", "$document", "$http", "$templateCache", "$timeout", "$injector", "$q", "$interpolate", "uiGridConstants", function (b, f, g, l, m, n, o, p, q, r) {
        function s(a, b) {
            ...
            if (b.originalEvent && (b = b.originalEvent), "detail"in b && (f = -1 * b.detail), "wheelDelta"in b && (f = b.wheelDelta), "wheelDeltaY"in b && (f = b.wheelDeltaY), "wheelDeltaX"in b && (e = -1 * b.wheelDeltaX), "axis"in b && b.axis === b.HORIZONTAL_AXIS && (e = -1 * f, f = 0), d = 0 === f ? e : f, "deltaY"in b && (f = -1 * b.deltaY, d = f), "deltaX"in b && (e = b.deltaX, 0 === f && (d = -1 * e)), 0 !== f || 0 !== e) {
                ...
                g = Math.max(Math.abs(f), Math.abs(e)), (!x || x > g) && (x = g, u(b, g) && (x /= 40)), d = Math[d >= 1 ? "floor" : "ceil"](d / x), e = Math[e >= 1 ? "floor" : "ceil"](e / x), f = Math[f >= 1 ? "floor" : "ceil"](f / x), b.deltaMode = 0;
                var j = {
                    originalEvent: b, deltaX: e, deltaY: f, deltaFactor: x, preventDefault: function () {
                        b.preventDefault()
                    }
                };
                w && clearTimeout(w), w = setTimeout(t, 200), a.call(c[0], j)
            }
        }
        ...
        var v = {
            ...
            getTemplate: function (a) {
                if (m.get(a))return v.postProcessTemplate(m.get(a));
                if (a.hasOwnProperty("then"))return a.then(v.postProcessTemplate);
                try {
                    if (angular.element(a).length > 0)return p.when(a).then(v.postProcessTemplate)
                } catch (b) {
                }
                return v.logDebug("fetching url", a), l({method: "GET", url: a}).then(function (b) {
                    var c = b.data.trim();
                    return m.put(a, c), c
                }, function (b) {
                    throw new Error("Could not get template " + a + ": " + b)
                }).then(v.postProcessTemplate)
            },
            postProcessTemplate: function (a) {
                var b = q.startSymbol(), c = q.endSymbol();
                return ("{{" !== b || "}}" !== c) && (a = a.replace(/\{\{/g, b), a = a.replace(/\}\}/g, c)), p.when(a)
            },
            ...
            fakeElement: function (a, b, c) {
                var d, e, f = angular.element(a).clone()[0];
                for (e in b)f.style[e] = b[e];
                return angular.element(document.body).append(f), d = c.call(f, f), angular.element(f).remove(), d
            },
            ...
            isTouchEnabled: function () {
                var a;
                return ("ontouchstart"in f || f.DocumentTouch && g instanceof DocumentTouch) && (a = !0), a
            },
            ...
            requestAnimationFrame: f.requestAnimationFrame && f.requestAnimationFrame.bind(f) || f.webkitRequestAnimationFrame && f.webkitRequestAnimationFrame.bind(f) || function (a) {
                return n(a, 10, !1)
            },
            ...
            enableAnimations: function (a) {
                var b;
                try {
                    return b = o.get("$animate"), b.enabled(!0, a), b
                } catch (c) {
                }
            },
            nextUid: function () {
            ...
            hashKey: function (a) {
                var b, c = typeof a;
                return "object" === c && null !== a ? "function" == typeof(b = a.$$hashKey) ? b = a.$$hashKey() : "undefined" != typeof a.$$hashKey && a.$$hashKey ? b = a.$$hashKey : void 0 === b && (b = a.$$hashKey = v.nextUid()) : b = a, c + ":" + b
            },
            resetUids: function () {
                j = ["0", "0", "0"]
            },
            logError: function (a) {
                r.LOG_ERROR_MESSAGES && b.error(a)
            },
            logWarn: function (a) {
                r.LOG_WARN_MESSAGES && b.warn(a)
            },
            logDebug: function () {
                r.LOG_DEBUG_MESSAGES && b.debug.apply(b, arguments)
            }
        };
        ["width", "height"].forEach(function (b) {
            var d = angular.uppercase(b.charAt(0)) + b.substr(1);
            v["element" + d] = function (d, e) {
                var f = d;
                if (f && "undefined" != typeof f.length && f.length && (f = d[0]), f) {
                    var g = a(f);
                    return 0 === f.offsetWidth && h.test(g.display) ? v.fakeElement(f, i, function (a) {
                        return c(a, b, e)
                    }) : c(f, b, e)
                }
                return null
            }, v["outerElement" + d] = function (a, b) {
                return a ? v["element" + d].call(this, a, b ? "margin" : "border") : null
            }
        }), v.closestElm = function (a, b) {
            ...
            return "unknown"
        }, v.normalizeScrollLeft = function (a) {
            "undefined" != typeof a.length && a.length && (a = a[0]);
            var b = v.detectBrowser(), c = a.scrollLeft, d = v.getStyles(a).direction;
            if ("ie" === b)return c;
            if ("chrome" === b) {
                if ("rtl" === d) {
            ...
            return "firefox" === b ? Math.abs(c) : c
        }, v.denormalizeScrollLeft = function (a, b) {
            "undefined" != typeof a.length && a.length && (a = a[0]);
            var c = v.detectBrowser(), d = v.getStyles(a).direction;
            if ("ie" === c)return b;
            if ("chrome" === c) {
                if ("rtl" === d) {
                    var e = a.scrollWidth - a.clientWidth;
            ...
            return "firefox" === c && "rtl" === d ? -1 * b : b
        }, v.preEval = function (a) {
            var b = r.BRACKET_REGEXP.exec(a);
            if (b)return (b[1] ? v.preEval(b[1]) : b[1]) + b[2] + (b[3] ? v.preEval(b[3]) : b[3]);
            a = a.replace(r.APOS_REGEXP, "\\'");
            var c = a.split(r.DOT_REGEXP), d = [c.shift()];
            return angular.forEach(c, function (a) {
                d.push(a.replace(r.FUNC_REGEXP, "']$1"))
            }), d.join("['")
            ...
            function d() {
                ...
                return e && n.cancel(e), e = n(d, b), i && (h = a.apply(g, f)), h
            }
            ...
            function d() {
                g = +new Date, a.apply(e, f), n(function () {
                    h = null
                }, 0)
            }
            ...
            return function () {
                if (e = this, f = arguments, null === h) {
                    var a = +new Date - g;
                    a > b ? d() : c.trailing && (h = n(d, b - a))
                }
            }
        }, v.on = {}, v.off = {}, v._events = {}, v.addOff = function (a) {
            v.off[a] = function (b, c) {
                var d = v._events[a].indexOf(c);
                d > 0 && v._events[a].removeAt(d)
            }
        };
        var w, x, y = "onwheel"in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"];
        return v.on.mousewheel = function (a, b) {
            if (a && b) {
                var c = angular.element(a);
                c.data("mousewheel-line-height", d(c)), c.data("mousewheel-page-height", v.elementHeight(c)), c.data("mousewheel-callbacks") || c.data("mousewheel-callbacks", {});
                var f = c.data("mousewheel-callbacks");
                f[b] = (Function.prototype.bind || e).call(s, c[0], b);
                for (var g = y.length; g;)c.on(y[--g], f[b])
            }
        }, v.off.mousewheel = function (a, b) {
            var c = angular.element(this), d = c.data("mousewheel-callbacks"), e = d[b];
            if (e)for (var f = y.length; f;)c.off(y[--f], e);
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("de", {
                ...
                pagination: {sizes: "Einträge pro Seite", totalItems: "Einträge"}
            }), a
        }])
    }])
}(), function () {
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("en", {
                ...
                //sort: {ascending: "Sort Ascending", descending: "Sort Descending", remove: "Remove Sort"},
                ...
                //    jsonNotArray: "Imported json file must contain an array, aborting."
                //},
                //pagination: {sizes: "items per page", totalItems: "items"}  aggregate: {label: "行"},
                ...
                pagination: {sizes: "行每页", totalItems: "行"}
            }), a
        }])
    }])
}(), function () {
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("fa", {
                aggregate: {label: "موردها"},
                groupPanel: {description: "یک عنوان ستون اینجا را بردار و به گروهی از آن ستون بیانداز."},
                search: {
                    placeholder: "جستجو...",
                ...
                menu: {text: "انتخاب ستون‌ها:"},
                column: {hide: "ستون پنهان کن"},
                aggregation: {count: "total rows: ", sum: "total: ", avg: "avg: ", min: "min: ", max: "max: "},
                gridMenu: {
                    columns: "Columns:",
                    importerTitle: "Import file",
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("fr", {
                aggregate: {label: "articles"},
                groupPanel: {description: "Faites glisser un en-tête de colonne ici et déposez-le vers un groupe par cette colonne."},
                search: {
                ...
                aggregation: {count: "total lignes: ", sum: "total: ", avg: "moy: ", min: "min: ", max: "max: "},
                ...
                pagination: {sizes: "articles par page", totalItems: "articles"}
            }), a
        }])
    }])
}(), function () {
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("ja", {
                aggregate: {label: "件"},
                groupPanel: {description: "列名部分をここにドラッグアンドドロップすることで列ごとにグループ分けを行うことができます。"},
                search: {
                    placeholder: "検索...",
                    showingItems: "絞込み件数:",
                    selectedItems: "選択件数:",
                ...
                menu: {text: "列選択:"},
                sort: {ascending: "昇順ソート", descending: "降順ソート", remove: "ソート取消"},
                column: {hide: "列を隠す"},
                aggregation: {count: "合計件数: ", sum: "合計: ", avg: "平均: ", min: "最小値: ", max: "最大値: "},
                pinning: {pinLeft: "左にピン留め", pinRight: "右にピン留め", unpin: "ピン留め取消"},
                gridMenu: {
                    columns: "列:",
                ...
                pagination: {sizes: "件 / ページ", totalItems: "件"}
            }), a
        }])
    }])
}(), function () {
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("pt-br", {
                ...
                sort: {ascending: "Ordenar Ascendente", descending: "Ordenar Descendente", remove: "Remover Ordenação"},
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("ru", {
                ...
                sort: {ascending: "По возрастанию", descending: "По убыванию", remove: "Убрать сортировку"},
            ...
            restrict: "EA", compile: function () {
                return {
                    pre: function (e, f, g) {
                        ...
                        var n = b(k), o = e.$on(d.UPDATE_EVENT, function () {
    ...
    var b = angular.module("ui.grid.cellNav", ["ui.grid"]);
    b.constant("uiGridCellNavConstants", {
        FEATURE_NAME: "gridCellNav",
        CELL_NAV_EVENT: "cellNav",
        direction: {LEFT: 0, RIGHT: 1, UP: 2, DOWN: 3, PG_UP: 4, PG_DOWN: 5},
        EVENT_TYPE: {KEYDOWN: 0, CLICK: 1, CLEAR: 2}
    }), b.factory("uiGridCellNavFactory", ["gridUtil", "uiGridConstants", "uiGridCellNavConstants", "$q", function (b, c, d) {
        ...
        return e.prototype.getFocusableCols = function () {
            var a = this.leftColumns.concat(this.columns, this.rightColumns);
            return a.filter(function (a) {
                return a.colDef.allowCellFocus
            })
        }, e.prototype.getFocusableRows = function () {
            return this.rows.filter(function (a) {
                return a.allowCellFocus !== !1
            })
        }, e.prototype.getNextRowCol = function (a, b, c) {
            switch (a) {
                case d.direction.LEFT:
                    return this.getRowColLeft(b, c);
                case d.direction.RIGHT:
                    return this.getRowColRight(b, c);
                case d.direction.UP:
                    return this.getRowColUp(b, c);
                case d.direction.DOWN:
                    return this.getRowColDown(b, c);
                case d.direction.PG_UP:
                    return this.getRowColPageUp(b, c);
                case d.direction.PG_DOWN:
                    return this.getRowColPageDown(b, c)
            }
        }, e.prototype.getRowColLeft = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            -1 === f && (f = 1);
            var h = 0 === f ? d.length - 1 : f - 1;
            return h > f ? 0 === g ? new a(b, d[h]) : new a(e[g - 1], d[h]) : new a(b, d[h])
        }, e.prototype.getRowColRight = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            -1 === f && (f = 0);
            var h = f === d.length - 1 ? 0 : f + 1;
            return f > h ? g === e.length - 1 ? new a(b, d[h]) : new a(e[g + 1], d[h]) : new a(b, d[h])
        }, e.prototype.getRowColDown = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            return -1 === f && (f = 0), g === e.length - 1 ? new a(b, d[f]) : new a(e[g + 1], d[f])
        }, e.prototype.getRowColPageDown = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            -1 === f && (f = 0);
            var h = this.bodyContainer.minRowsToRender();
            return g >= e.length - h ? new a(e[e.length - 1], d[f]) : new a(e[g + h], d[f])
        }, e.prototype.getRowColUp = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            return -1 === f && (f = 0), 0 === g ? new a(b, d[f]) : new a(e[g - 1], d[f])
        }, e.prototype.getRowColPageUp = function (b, c) {
            var d = this.getFocusableCols(), e = this.getFocusableRows(), f = d.indexOf(c), g = e.indexOf(b);
            -1 === f && (f = 0);
            var h = this.bodyContainer.minRowsToRender();
            return 0 > g - h ? new a(e[0], d[f]) : new a(e[g - h], d[f])
        }, e
    }]), b.service("uiGridCellNavService", ["gridUtil", "uiGridConstants", "uiGridCellNavConstants", "$q", "uiGridCellNavFactory", "ScrollEvent", function (a, b, c, d, e, f) {
        var g = {
            initializeGrid: function (a) {
                a.registerColumnBuilder(g.cellNavColumnBuilder), a.cellNav = {}, a.cellNav.lastRowCol = null, a.cellNav.focusedCells = [], g.defaultGridOptions(a.options);
                var b = {
                    events: {
                        cellNav: {
                            navigate: function () {
                        ...
                        cellNav: {
                            scrollTo: function (b, c) {
                                ...
                                g.scrollToFocus(a, b, c)
                            }, scrollToIfNecessary: function (b, c) {
                                g.scrollToIfNecessary(a, b, c)
                ...
                var b = a.hasRightContainer() ? a.renderContainers.right : null, c = a.hasLeftContainer() ? a.renderContainers.left : null;
                ...
                return a.keyCode === b.keymap.LEFT || a.keyCode === b.keymap.TAB && a.shiftKey ? c.direction.LEFT : a.keyCode === b.keymap.RIGHT || a.keyCode === b.keymap.TAB ? c.direction.RIGHT : a.keyCode === b.keymap.UP || a.keyCode === b.keymap.ENTER && a.shiftKey ? c.direction.UP : a.keyCode === b.keymap.PG_UP ? c.direction.PG_UP : a.keyCode === b.keymap.DOWN || a.keyCode === b.keymap.ENTER ? c.direction.DOWN : a.keyCode === b.keymap.PG_DOWN ? c.direction.PG_DOWN : null
            }, cellNavColumnBuilder: function (a) {
                var b = [];
                return a.allowCellFocus = void 0 === a.allowCellFocus ? !0 : a.allowCellFocus, d.all(b)
            }, scrollTo: function (a, b, c) {
                var d = null, e = null;
                null !== b && "undefined" != typeof b && (d = a.getRow(b)), null !== c && "undefined" != typeof c && (e = a.getColumn(c.name ? c.name : c.field)), this.scrollToInternal(a, d, e)
            }, scrollToFocus: function (a, b, c) {
                var d = null, e = null;
                null !== b && (d = a.getRow(b)), null !== c && (e = a.getColumn(c.name ? c.name : c.field)), this.scrollToInternal(a, d, e);
                var f = {row: d, col: e};
                a.cellNav.broadcastCellNav(f)
            }, scrollToInternal: function (a, b, c) {
                var d = new f(a, null, null, "uiGridCellNavService.scrollToInternal");
                if (null !== b) {
                    var e = a.renderContainers.body.visibleRowCache.indexOf(b), g = a.renderContainers.body.visibleRowCache.length, h = (e + e / (g - 1)) / g;
                    d.y = {percentage: h}
                }
                null !== c && (d.x = {percentage: this.getLeftWidth(a, c) / this.getLeftWidth(a, a.renderContainers.body.visibleColumnCache[a.renderContainers.body.visibleColumnCache.length - 1])}), (d.y || d.x) && d.fireScrollingEvent()
            }, scrollToIfNecessary: function (a, b, c) {
                var d = new f(a, "uiGridCellNavService.scrollToIfNecessary"), e = a.renderContainers.body.visibleRowCache, g = a.renderContainers.body.visibleColumnCache, h = a.renderContainers.body.prevScrollTop + a.headerHeight;
                h = 0 > h ? 0 : h;
                var i = a.renderContainers.body.prevScrollLeft, j = a.renderContainers.body.prevScrollTop + a.gridHeight - a.headerHeight, k = a.renderContainers.body.prevScrollLeft + Math.ceil(a.gridWidth);
                if (null !== b) {
                    var l = e.indexOf(b), m = a.renderContainers.body.getCanvasHeight() - a.renderContainers.body.getViewportHeight(), n = (l + 1) * a.options.rowHeight;
                    n = 0 > n ? 0 : n;
                    var o, p;
                    h > n ? (o = a.renderContainers.body.prevScrollTop - (h - n), p = o / m, d.y = {percentage: p}) : n > j && (o = n - j + a.renderContainers.body.prevScrollTop, p = o / m, d.y = {percentage: p})
                }
                if (null !== c) {
                    for (var q = g.indexOf(c), r = a.renderContainers.body.getCanvasWidth() - a.renderContainers.body.getViewportWidth(), s = 0, t = 0; q > t; t++) {
                        var u = g[t];
                        s += u.drawnWidth
                    }
                    s = 0 > s ? 0 : s;
                    var v = s + c.drawnWidth;
                    v = 0 > v ? 0 : v;
                    var w, x;
                    i > s ? (w = a.renderContainers.body.prevScrollLeft - (i - s), x = w / r, x = x > 1 ? 1 : x, d.x = {percentage: x}) : v > k && (w = v - k + a.renderContainers.body.prevScrollLeft, x = w / r, x = x > 1 ? 1 : x, d.x = {percentage: x})
                }
                (d.y || d.x) && d.fireScrollingEvent()
        ...
        return g
    }]), b.directive("uiGridCellnav", ["gridUtil", "uiGridCellNavService", "uiGridCellNavConstants", "uiGridConstants", function (b, c, d, e) {
        return {
            replace: !0, priority: -150, require: "^uiGrid", scope: !1, controller: function () {
            }, compile: function () {
                return {
                    pre: function (b, f, g, h) {
                        var i = b, j = h.grid;
                        c.initializeGrid(j), h.cellNav = {}, h.cellNav.focusCell = function (a, b) {
                            h.cellNav.broadcastCellNav({row: a, col: b})
                        }, h.cellNav.broadcastCellNav = j.cellNav.broadcastCellNav = function (a, b) {
                            b = !(void 0 === b || !b), h.cellNav.broadcastFocus(a, b), i.$broadcast(d.CELL_NAV_EVENT, a, b)
                        }, h.cellNav.clearFocus = j.cellNav.clearFocus = function () {
                            i.$broadcast(d.CELL_NAV_EVENT, {eventType: d.EVENT_TYPE.CLEAR})
                        }, h.cellNav.broadcastFocus = function (b, c) {
                            c = !(void 0 === c || !c);
                            var d = b.row, e = b.col, f = h.grid.api.cellNav.rowColSelectIndex(b);
                            if (null === j.cellNav.lastRowCol || -1 === f) {
                                var g = new a(d, e);
                                j.api.cellNav.raise.navigate(g, j.cellNav.lastRowCol), j.cellNav.lastRowCol = g, h.grid.options.modifierKeysToMultiSelectCells && c ? j.cellNav.focusedCells.push(b) : j.cellNav.focusedCells = [b]
                            } else j.options.modifierKeysToMultiSelectCells && c && f >= 0 && j.cellNav.focusedCells.splice(f, 1)
                        }, h.cellNav.handleKeyDown = function (a) {
                            var b = c.getDirection(a);
                            if (null === b)return !0;
                            var f = "body";
                            a.uiGridTargetRenderContainerId && (f = a.uiGridTargetRenderContainerId);
                            var g = h.grid.api.cellNav.getFocusedCell();
                            if (g) {
                                var i = h.grid.renderContainers[f].cellNav.getNextRowCol(b, g.row, g.col);
                                return b === d.direction.LEFT && i.row === g.row && a.keyCode === e.keymap.TAB && a.shiftKey ? (h.cellNav.clearFocus(), !0) : b !== d.direction.RIGHT || i.row !== g.row || a.keyCode !== e.keymap.TAB || a.shiftKey ? (i.eventType = d.EVENT_TYPE.KEYDOWN, h.cellNav.broadcastCellNav(i), c.scrollToIfNecessary(j, i.row, i.col), a.stopPropagation(), a.preventDefault(), !1) : (h.cellNav.clearFocus(), !0)
                            }
                        }
                    }, post: function () {
                    }
    ...
    }]), b.directive("uiGridRenderContainer", ["$timeout", "$document", "gridUtil", "uiGridConstants", "uiGridCellNavService", "uiGridCellNavConstants", function (a, b, c, d, e) {
        return {
            replace: !0,
            priority: -99999,
            ...
            compile: function () {
                return {
                    post: function (c, d, f, g) {
                        var h = g[0], i = g[1];
                        if (h.grid.api.cellNav) {
                            var j = i.containerId, k = h.grid;
                            e.decorateRenderContainers(k), d.attr("tabindex", -1), d.on("keydown", function (a) {
                                return a.uiGridTargetRenderContainerId = j, h.cellNav.handleKeyDown(a)
                            });
                            var l = !1;
                            k.api.core.on.scrollEvent(c, function (c) {
                                c.grid && c.grid.id !== h.grid.id || null != h.grid.api.cellNav.getFocusedCell() && ("uiGridCellNavService.scrollToIfNecessary" === c.source ? l = !0 : l && a(function () {
                                    a(function () {
                                        var a = h.grid.api.cellNav.getFocusedCell();
                                        b.activeElement === b.body && d[0].focus(), h.cellNav.broadcastCellNav(a), l = !1
                                    })
                                }))
                            })
                        }
    ...
    }]), b.directive("uiGridCell", ["$timeout", "$document", "uiGridCellNavService", "gridUtil", "uiGridCellNavConstants", "uiGridConstants", function (b, c, d, e, f) {
        return {
            priority: -150, restrict: "A", require: "^uiGrid", scope: !1, link: function (b, c, d, e) {
                function g() {
                    c.find("div").attr("tabindex", 0)
                }
                ...
                e.grid.api.cellNav && b.col.colDef.allowCellFocus && (g(), c.find("div").on("click", function (c) {
                    e.cellNav.broadcastCellNav(new a(b.row, b.col), c.ctrlKey || c.metaKey), c.stopPropagation()
                }), c.find("div").on("focus", function (c) {
                    console.log("cellNav focus"), e.cellNav.broadcastCellNav(new a(b.row, b.col), c.ctrlKey || c.metaKey)
                }), b.$on(f.CELL_NAV_EVENT, function (a, d, g) {
                    return a.eventType === f.EVENT_TYPE.CLEAR ? void i() : void(d.row === b.row && d.col === b.col ? (e.grid.options.modifierKeysToMultiSelectCells && g && -1 === e.grid.api.cellNav.rowColSelectIndex(d) ? i() : h(), d.hasOwnProperty("eventType") && d.eventType === f.EVENT_TYPE.KEYDOWN && (console.log("focus from navEvent"), c.find("div")[0].focus())) : e.grid.options.modifierKeysToMultiSelectCells && g || i())
                }), b.$on("$destroy", function () {
                    c.find("div").off("click")
                }))
            }
        }
    }])
    ...
    }), a.service("uiGridEditService", ["$q", "$templateCache", "uiGridConstants", "gridUtil", function (a, b, c, d) {
        var e = {
            initializeGrid: function (a) {
                e.defaultGridOptions(a.options), a.registerColumnBuilder(e.editColumnBuilder);
                var b = {
                    events: {
                        edit: {
                ...
                return a.keyCode === c.keymap.LEFT || a.keyCode === c.keymap.TAB && a.shiftKey || a.keyCode === c.keymap.RIGHT || a.keyCode === c.keymap.TAB || a.keyCode === c.keymap.UP || a.keyCode === c.keymap.ENTER && a.shiftKey || a.keyCode === c.keymap.DOWN || a.keyCode === c.keymap.ENTER ? !1 : !0
            }
        };
        return e
    ...
    }]), a.directive("uiGridCell", ["$compile", "$injector", "$timeout", "uiGridConstants", "uiGridEditConstants", "gridUtil", "$parse", "uiGridEditService", function (a, b, c, d, e, f, g, h) {
        var i = 500;
        return {
            priority: -100, restrict: "A", scope: !1, require: "?^uiGrid", link: function (f, j, k, l) {
                function m() {
                    j.on("dblclick", t), j.on("keydown", r), f.col.colDef.enableCellEditOnFocus && j.find("div").on("focus", q), j.on("touchstart", n)
                }

                function n(a) {
                    "undefined" != typeof a.originalEvent && void 0 !== a.originalEvent && (a = a.originalEvent), j.on("touchend", o), A = c(function () {
                    }, i), A.then(function () {
                        setTimeout(t, 0), j.off("touchend", o)
                    })
                }

                function o() {
                    c.cancel(A), j.off("touchend", o)
                }

                function p() {
                    j.off("dblclick", t), j.off("keydown", r), f.col.colDef.enableCellEditOnFocus && j.find("div").off("focus", q), j.off("touchstart", n)
                }

                function q(a) {
                    l && l.cellNav && l.cellNav.focusCell(f.row, f.col), a.stopPropagation(), t()
                }

                function r(a) {
                    h.isStartEditKey(a) && t()
                }

                function s(a, b) {
                    return !b.isSaving && (angular.isFunction(a.colDef.cellEditableCondition) ? a.colDef.cellEditableCondition(f) : a.colDef.cellEditableCondition)
                }

                function t() {
                    if (!C && s(f.col, f.row)) {
                        f.grid.api.cellNav && f.grid.api.cellNav.scrollToIfNecessary(f.row, f.col), z = g(f.row.getQualifiedColField(f.col)), y = z(f), x = f.col.editableCellTemplate, x = x.replace(d.MODEL_COL_FIELD, f.row.getQualifiedColField(f.col));
                        var b = f.col.colDef.editDropdownFilter ? "|" + f.col.colDef.editDropdownFilter : "";
                        x = x.replace(d.CUSTOM_FILTERS, b);
                        var c = "text";
                        switch (f.col.colDef.type) {
                            case"boolean":
                                c = "checkbox";
                                break;
                            case"number":
                        ...
                        x = x.replace("INPUT_TYPE", c);
                        var h = f.col.colDef.editDropdownRowEntityOptionsArrayPath;
                        f.editDropdownOptionsArray = h ? w(f.row.entity, h) : f.col.colDef.editDropdownOptionsArray, f.editDropdownIdLabel = f.col.colDef.editDropdownIdLabel ? f.col.colDef.editDropdownIdLabel : "id", f.editDropdownValueLabel = f.col.colDef.editDropdownValueLabel ? f.col.colDef.editDropdownValueLabel : "value";
                        f.$apply(function () {
                            C = !0, p();
                            var b = angular.element(x);
                            j.append(b), B = f.$new(), a(b)(B);
                            var c = angular.element(j.children()[0]);
                            D = c.hasClass("ui-grid-cell-focus"), c.addClass("ui-grid-cell-contents-hidden")
                        });
                        var i = f.col.grid.api.core.on.scrollEvent(f, function () {
                            u(!0), f.grid.api.edit.raise.afterCellEdit(f.row.entity, f.col.colDef, z(f), y), i(), k(), l()
                        }), k = f.$on(e.events.END_CELL_EDIT, function (a, b) {
                            u(b), f.grid.api.edit.raise.afterCellEdit(f.row.entity, f.col.colDef, z(f), y), k(), i(), l()
                        }), l = f.$on(e.events.CANCEL_CELL_EDIT, function () {
                            v(), l(), i(), k()
                        });
                        f.$broadcast(e.events.BEGIN_CELL_EDIT), f.grid.api.edit.raise.beginCellEdit(f.row.entity, f.col.colDef)
                    }
                }

                function u(a) {
                    if (C) {
                        var b = angular.element(j.children()[0]);
                        B.$destroy(), angular.element(j.children()[1]).remove(), b.removeClass("ui-grid-cell-contents-hidden"), a && D && b[0].focus(), D = !1, C = !1, m(), f.grid.api.core.notifyDataChange(d.dataChange.EDIT)
                    }
                }

                function v() {
                    C && (z.assign(f, y), f.$apply(), f.grid.api.edit.raise.cancelCellEdit(f.row.entity, f.col.colDef), u(!0))
                }
                ...
                if (f.col.colDef.enableCellEdit && f.row.enableCellEdit !== !1) {
                    var x, y, z, A, B, C = !1, D = !1;
                    m();
                    try {
                        var E = b.get("uiGridCellNavConstants");
                        f.col.colDef.enableCellEditOnFocus && f.$on(E.CELL_NAV_EVENT, function (a, b) {
                            b.row === f.row && b.col === f.col ? t() : u()
                        })
                    } catch (F) {
                    }
                }
    ...
    }]), a.directive("uiGridEditor", ["gridUtil", "uiGridConstants", "uiGridEditConstants", function (a, b, c) {
        return {
            scope: !0, require: ["?^uiGrid", "?^uiGridRenderContainer"], compile: function () {
                return {
                    pre: function () {
                        ...
                        var g, h;
                        f[0] && (g = f[0]), f[1] && (h = f[1]), a.$on(c.events.BEGIN_CELL_EDIT, function () {
                            d[0].focus(), d[0].select(), d.on("blur", function (b) {
                                a.stopEdit(b)
                            })
                            ...
                            if (a.deepEdit)switch (d.keyCode) {
                                case b.keymap.LEFT:
                                    d.stopPropagation();
                                    break;
                                case b.keymap.RIGHT:
                                ...
                                case b.keymap.DOWN:
                                    d.stopPropagation()
                            } else g && g.hasOwnProperty("cellNav") && h && (d.uiGridTargetRenderContainerId = h.containerId, g.cellNav.handleKeyDown(d));
                            return !0
                        })
                    }
                }
    ...
    a.service("uiGridExpandableService", ["gridUtil", "$compile", function (a) {
        var b = {
            initializeGrid: function (c) {
                c.expandable = {}, c.expandable.expandedAll = !1, c.options.enableExpandable = c.options.enableExpandable !== !1, c.options.expandableRowHeight = c.options.expandableRowHeight || 150, c.options.expandableRowHeaderWidth = c.options.expandableRowHeaderWidth || 40, c.options.enableExpandable && !c.options.expandableRowTemplate && (a.logError("You have not set the expandableRowTemplate, disabling expandable module"), c.options.enableExpandable = !1);
                var d = {
                    events: {
                        expandable: {
                            rowExpandedStateChanged: function () {
                            }
                        }
                    }, methods: {
                        expandable: {
                            toggleRowExpansion: function (a) {
                                var d = c.getRow(a);
                                null !== d && b.toggleRowExpansion(c, d)
                ...
                c.api.registerEventsFromObject(d.events), c.api.registerMethodsFromObject(d.methods)
                ...
                angular.forEach(a.renderContainers.body.visibleRowCache, function (c) {
                    c.isExpanded || b.toggleRowExpansion(a, c)
                }), a.expandable.expandedAll = !0, a.refresh()
            }, collapseAllRows: function (a) {
                angular.forEach(a.renderContainers.body.visibleRowCache, function (c) {
                    c.isExpanded && b.toggleRowExpansion(a, c)
                }), a.expandable.expandedAll = !1, a.refresh()
            }, toggleAllRows: function (a) {
                a.expandable.expandedAll ? b.collapseAllRows(a) : b.expandAllRows(a)
            }
        };
        return b
    ...
    }]), a.directive("uiGrid", ["uiGridExpandableService", "$templateCache", function () {
        return {
            replace: !0, priority: 1e3, require: "^uiGrid", scope: !1, compile: function () {
                return {
                    pre: function (a, b, c, d) {
    ...
    }]), a.directive("uiGridExpandableRow", ["uiGridExpandableService", "$timeout", "$compile", "uiGridConstants", "gridUtil", "$interval", "$log", function (a, b, c, d, e) {
        return {
    ...
    }]), a.directive("uiGridRow", ["$compile", "gridUtil", "$templateCache", function () {
        return {
            priority: -200, scope: !1, compile: function () {
                return {
                    pre: function (a) {
                        function b() {
                            var b = a.grid, c = 0;
                            return angular.forEach(b.columns, function (a) {
                                "left" === a.renderContainer && (c += a.width)
                            }), c = Math.floor(c), ".grid" + b.id + " .ui-grid-pinned-container-" + a.colContainer.name + ", .grid" + b.id + " .ui-grid-pinned-container-" + a.colContainer.name + " .ui-grid-render-container-" + a.colContainer.name + " .ui-grid-viewport .ui-grid-canvas .ui-grid-row { width: " + c + "px; }"
                        }
                        ...
                        a.expandableRow = {}, a.expandableRow.shouldRenderExpand = function () {
                            ...
                            return b
                        }, "left" === a.colContainer.name && a.grid.registerStyleComputation({priority: 15, func: b})
                    }, post: function () {
                    }
                }
            }
        ...
        return {
            priority: -200, scope: !1, compile: function (a) {
                var b = angular.element(a.children().children()[0]), d = c.get("ui-grid/expandableScrollFiller"), e = c.get("ui-grid/expandableRow");
                return b.append(e), b.append(d), {
                    pre: function () {
                    }, post: function () {
                    }
                }
    ...
    a.constant("uiGridExporterConstants", {
        ...
        FILE_NAME: "FILE_NAME"
    }), a.service("uiGridExporterService", ["$q", "uiGridExporterConstants", "uiGridSelectionConstants", "gridUtil", "$compile", "$interval", "i18nService", function (a, b, c, d, e, f, g) {
        var h = {
            initializeGrid: function (a) {
                ...
                a.api.registerEventsFromObject(b.events), a.api.registerMethodsFromObject(b.methods), a.api.core.addToGridMenu ? h.addToMenu(a) : f(function () {
                    a.api.core.addToGridMenu && h.addToMenu(a)
                }, 100, 1)
            }, defaultGridOptions: function (a) {
                a.exporterSuppressMenu = a.exporterSuppressMenu === !0, a.exporterMenuLabel = a.exporterMenuLabel ? a.exporterMenuLabel : "Export", a.exporterSuppressColumns = a.exporterSuppressColumns ? a.exporterSuppressColumns : [], a.exporterCsvColumnSeparator = a.exporterCsvColumnSeparator ? a.exporterCsvColumnSeparator : ",", a.exporterCsvFilename = a.exporterCsvFilename ? a.exporterCsvFilename : "download.csv", a.exporterPdfDefaultStyle = a.exporterPdfDefaultStyle ? a.exporterPdfDefaultStyle : {fontSize: 11}, a.exporterPdfTableStyle = a.exporterPdfTableStyle ? a.exporterPdfTableStyle : {margin: [0, 5, 0, 15]}, a.exporterPdfTableHeaderStyle = a.exporterPdfTableHeaderStyle ? a.exporterPdfTableHeaderStyle : {
                    ...
                    fontSize: 12,
                    color: "black"
                }, a.exporterPdfHeader = a.exporterPdfHeader ? a.exporterPdfHeader : null, a.exporterPdfFooter = a.exporterPdfFooter ? a.exporterPdfFooter : null, a.exporterPdfOrientation = a.exporterPdfOrientation ? a.exporterPdfOrientation : "landscape", a.exporterPdfPageSize = a.exporterPdfPageSize ? a.exporterPdfPageSize : "A4", a.exporterPdfMaxGridWidth = a.exporterPdfMaxGridWidth ? a.exporterPdfMaxGridWidth : 720, a.exporterMenuCsv = void 0 !== a.exporterMenuCsv ? a.exporterMenuCsv : !0, a.exporterMenuPdf = void 0 !== a.exporterMenuPdf ? a.exporterMenuPdf : !0, a.exporterPdfCustomFormatter = a.exporterPdfCustomFormatter && "function" == typeof a.exporterPdfCustomFormatter ? a.exporterPdfCustomFormatter : function (a) {
                    return a
                ...
                a.api.core.addToGridMenu(a, [{
                    title: g.getSafeText("gridMenu.exporterAllAsCsv"), action: function () {
                        this.grid.api.exporter.csvExport(b.ALL, b.ALL)
                    }, shown: function () {
                        return this.grid.options.exporterMenuCsv
                    }
                }, {
                    title: g.getSafeText("gridMenu.exporterVisibleAsCsv"), action: function () {
                        this.grid.api.exporter.csvExport(b.VISIBLE, b.VISIBLE)
                    }, shown: function () {
                        return this.grid.options.exporterMenuCsv
                    }
                }, {
                    title: g.getSafeText("gridMenu.exporterSelectedAsCsv"), action: function () {
                    ...
                    title: g.getSafeText("gridMenu.exporterAllAsPdf"), action: function () {
                        this.grid.api.exporter.pdfExport(b.ALL, b.ALL)
                    }, shown: function () {
                        return this.grid.options.exporterMenuPdf
                    }
                }, {
                    title: g.getSafeText("gridMenu.exporterVisibleAsPdf"), action: function () {
                        this.grid.api.exporter.pdfExport(b.VISIBLE, b.VISIBLE)
                    }, shown: function () {
                        return this.grid.options.exporterMenuPdf
                    }
                }, {
                    title: g.getSafeText("gridMenu.exporterSelectedAsPdf"), action: function () {
                ...
                var d = this.getColumnHeaders(a, c), e = this.getData(a, b, c), f = this.formatAsCsv(d, e, a.options.exporterCsvColumnSeparator);
                this.downloadFile(a.options.exporterCsvFilename, f)
            }, getColumnHeaders: function (a, c) {
                var d = [];
                return angular.forEach(a.columns, function (e) {
                    !e.visible && c !== b.ALL || e.colDef.exporterSuppressExport === !0 || -1 !== a.options.exporterSuppressColumns.indexOf(e.name) || d.push({
                        name: e.field,
                        displayName: a.options.exporterHeaderFilter ? a.options.exporterHeaderFilter(a.options.exporterHeaderFilterUseName ? e.name : e.displayName) : e.displayName,
                        width: e.drawnWidth ? e.drawnWidth : e.width,
                        align: "number" === e.colDef.type ? "right" : "left"
                    })
                }), d
                ...
                switch (c) {
                    ...
                    case b.VISIBLE:
                        ...
                        break;
                    case b.SELECTED:
                        a.api.selection ? f = a.api.selection.getSelectedGridRows() : d.logError("selection feature must be enabled to allow selected rows to be exported")
                }
                return angular.forEach(f, function (c) {
                    if (c.exporterEnableExporting !== !1) {
                        var d = [];
                        angular.forEach(a.columns, function (f) {
                            if ((f.visible || e === b.ALL) && f.colDef.exporterSuppressExport !== !0 && -1 === a.options.exporterSuppressColumns.indexOf(f.name)) {
                                var g = {value: a.options.exporterFieldCallback(a, c, f, a.getCellValue(c, f))};
                                f.colDef.exporterPdfAlign && (g.alignment = f.colDef.exporterPdfAlign), d.push(g)
                            }
                        }), g.push(d)
                    }
                }), g
                ...
                var c, d = document, e = d.createElement("a"), f = "application/octet-stream;charset=utf-8";
                if (navigator.msSaveBlob)return navigator.msSaveBlob(new Blob(["﻿", b], {type: f}), a);
                if ("download"in e) {
                    var g = new Blob([b], {type: f});
                    c = URL.createObjectURL(g), e.setAttribute("download", a)
                } else c = "data:" + f + "," + encodeURIComponent(b), e.setAttribute("target", "_blank");
                e.href = c, e.setAttribute("style", "display:none;"), d.body.appendChild(e), setTimeout(function () {
                ...
                var d = this.getColumnHeaders(a, c), e = this.getData(a, b, c), f = this.prepareAsPdf(a, d, e);
                pdfMake.createPdf(f).open()
        ...
        return h
    }]), a.directive("uiGridExporter", ["uiGridExporterConstants", "uiGridExporterService", "gridUtil", "$compile", function (a, b) {
        return {
    ...
    a.constant("uiGridImporterConstants", {featureName: "importer"}), a.service("uiGridImporterService", ["$q", "uiGridConstants", "uiGridImporterConstants", "gridUtil", "$compile", "$interval", "i18nService", "$window", function (a, b, c, d, e, f, g, h) {
        var i = {
            initializeGrid: function (a, b) {
                ...
                a.api.core.addToGridMenu(a, [{title: g.getSafeText("gridMenu.importerTitle")}, {
                ...
                return function (b) {
                    var c, d = [];
                    angular.forEach(i.parseJson(a, b), function (b) {
                ...
                return angular.forEach(b, function (b) {
                    d = i.newObject(a), angular.forEach(b, function (a, b) {
                        null !== c[b] && (d[c[b]] = a)
                ...
                if (a.options.columnDefs && 0 !== a.options.columnDefs.length) {
                    ...
                    return angular.forEach(b, function (a) {
                        c.push(d[a] ? d[a] : d[a.toLowerCase()] ? d[a.toLowerCase()] : null)
                    }), c
                }
                return angular.forEach(b, function (a) {
            ...
            }, addObjects: function (a, c) {
                if (a.api.rowEdit) {
                    var d = a.registerDataChangeCallback(function () {
                        a.api.rowEdit.setRowsDirty(c), d()
                    }, [b.dataChange.ROW]);
                    a.importer.$scope.$on("$destroy", d)
                }
        ...
        return i
    }]), a.directive("uiGridImporter", ["uiGridImporterConstants", "uiGridImporterService", "gridUtil", "$compile", function (a, b) {
        return {
            replace: !0, priority: 0, require: "^uiGrid", scope: !1, link: function (a, c, d, e) {
                b.initializeGrid(a, e.grid)
            }
        }
    }]), a.directive("uiGridImporterMenuItem", ["uiGridImporterConstants", "uiGridImporterService", "gridUtil", "$compile", function (a, b, c) {
        return {
            replace: !0,
            priority: 0,
            require: "^uiGrid",
    ...
    a.service("uiGridInfiniteScrollService", ["gridUtil", "$compile", "$timeout", "uiGridConstants", function (a, b, c, d) {
        var e = {
            initializeGrid: function (a) {
                ...
                var b = {
                    events: {
                        ...
                        infiniteScroll: {
                            dataLoaded: function () {
                                a.options.loadTimout = !1
                            }
                        }
                    }
                };
                a.options.loadTimout = !1, a.api.registerEventsFromObject(b.events), a.api.registerMethodsFromObject(b.methods)
            }, defaultGridOptions: function (a) {
                a.enableInfiniteScroll = a.enableInfiniteScroll !== !1
            }, loadData: function (a) {
                return a.options.loadTimout = !0, a.scrollDirection === d.scrollDirection.UP ? void a.api.infiniteScroll.raise.needLoadMoreDataTop() : void a.api.infiniteScroll.raise.needLoadMoreData()
            }, checkScroll: function (a, b) {
                var c = a.options.infiniteScrollPercentage ? a.options.infiniteScrollPercentage : 20;
                return !a.options.loadTimout && c >= b ? (this.loadData(a), !0) : !1
            }
        };
        return e
    }]), a.directive("uiGridInfiniteScroll", ["uiGridInfiniteScrollService", function (a) {
        return {
            priority: -200, scope: !1, require: "^uiGrid", compile: function () {
                return {
    ...
    }]), a.directive("uiGridViewport", ["$compile", "gridUtil", "uiGridInfiniteScrollService", "uiGridConstants", function (a, b, c, d) {
        return {
            priority: -200, scope: !1, link: function (a) {
                a.grid.options.enableInfiniteScroll && a.grid.api.core.on.scrollEvent(a, function (b) {
                    if (b.y && "ui.grid.adjustInfiniteScrollPosition" !== b.source) {
                        var e = 100 - 100 * b.y.percentage;
                        a.grid.scrollDirection === d.scrollDirection.UP && (e = 100 * b.y.percentage), c.checkScroll(a.grid, e)
                    }
                })
            }
        }
    ...
    a.service("uiGridMoveColumnService", ["$q", "$timeout", "$log", "ScrollEvent", "uiGridConstants", function (a, b, c, d, e) {
        var f = {
            initializeGrid: function (a) {
                var b = this;
                    ...
                    events: {
                        ...
                        colMovable: {
                            moveColumn: function (c, d) {
                                var e = a.columns;
                                if (!angular.isNumber(c) || !angular.isNumber(d))return void console.log("Please provide valid values for originalPosition and finalPosition");
                                for (var f = 0, g = 0; g < e.length; g++)(angular.isDefined(e[g].colDef.visible) && e[g].colDef.visible === !1 || e[g].isRowHeader === !0) && f++;
                                if (c >= e.length - f || d >= e.length - f)return void console.log("Invalid values for originalPosition, finalPosition");
                                var h = function (a) {
                                ...
                                b.redrawColumnAtPosition(a, h(c), h(d))
                            }
                        }
                    }
                };
                ...
                if (g.colDef.enableColumnMoving) {
                    if (c > d)for (var h = c; h > d; h--)f[h] = f[h - 1]; else if (d > c)for (var i = c; d > i; i++)f[i] = f[i + 1];
                    f[d] = g, b(function () {
                        a.refresh(), a.api.colMovable.raise.columnPositionChanged(g.colDef, c, d), a.api.core.notifyDataChange(e.dataChange.COLUMN)
                    })
                }
            }
        };
        ...
        return {
            priority: -10, require: "^uiGrid", compile: function () {
                return {
                    post: function (a, e, h, i) {
                        a.col.colDef.enableColumnMoving && a.$on(f.events.COLUMN_HEADER_CLICK, function (f, h) {
                            if (h.columnName === a.col.colDef.name && !a.col.renderContainer) {
                                var j = h.event;
                                if ("ui-grid-icon-angle-down" !== j.target.className && "I" !== j.target.tagName && j.target.className.indexOf("ui-grid-filter-input") < 0) {
                                    var k, l, m = a.grid.element[0].getBoundingClientRect().left, n = j.pageX, o = 0, p = m + a.grid.getViewportWidth(), q = !1, r = function () {
                                        q = !0, k = e.clone(), e.parent().append(k), k.addClass("movingColumn");
                                        var b = {}, c = e[0].getBoundingClientRect().left;
                                        b.left = c - m + "px";
                                        var d = a.grid.element[0].getBoundingClientRect().right, f = e[0].getBoundingClientRect().right;
                                        f > d && (l = a.col.drawnWidth + (d - f), b.width = l + "px"), k.css(b)
                                    }, s = function (c) {
                                        i.fireEvent("hide-menu");
                                        for (var d = a.grid.columns, e = 0, f = 0; f < d.length; f++)(angular.isUndefined(d[f].colDef.visible) || d[f].colDef.visible === !0) && (e += d[f].drawnWidth || d[f].width || d[f].colDef.width);
                                        var h, j = k[0].getBoundingClientRect().left - 1, n = k[0].getBoundingClientRect().right;
                                        if (h = "ie" === b.detectBrowser() ? j + c : j - m + c, h = p > h ? h : p, (j >= m || c > 0) && (p >= n || 0 > c))k.css({
                                            visibility: "visible",
                                            left: h + "px"
                                        }); else if (e > Math.ceil(i.grid.gridWidth)) {
                                            c *= 8;
                                            var q = new g(a.col.grid, null, null, "uiGridHeaderCell.moveElement");
                                            q.x = {pixels: c}, q.fireScrollingEvent()
                                        }
                                        for (var r = 0, s = 0; s < d.length; s++)if (angular.isUndefined(d[s].colDef.visible) || d[s].colDef.visible === !0) {
                                            if (d[s].colDef.name === a.col.colDef.name)break;
                                            r += d[s].drawnWidth || d[s].width || d[s].colDef.width
                                        }
                                        void 0 === a.newScrollLeft ? o += c : o = a.newScrollLeft + h - r, l < a.col.drawnWidth && (l += Math.abs(c), k.css({width: l + "px"}))
                                    }, t = function (a) {
                                        document.onselectstart = function () {
                                            return !1
                                        };
                                        var b = a.pageX - n;
                                        !q && Math.abs(b) > 50 ? r() : q && (s(b), n = a.pageX)
                                    };
                                    d.on("mousemove", t);
                                    var u = function () {
                                        document.onselectstart = null, k && k.remove();
                                        for (var b = a.grid.columns, e = 0, f = 0; f < b.length && b[f].colDef.name !== a.col.colDef.name; f++)e++;
                                        if (0 > o) {
                                            for (var g = 0, h = e - 1; h >= 0; h--)if ((angular.isUndefined(b[h].colDef.visible) || b[h].colDef.visible === !0) && (g += b[h].drawnWidth || b[h].width || b[h].colDef.width, g > Math.abs(o))) {
                                                c.redrawColumnAtPosition(a.grid, e, h + 1);
                                                break
                                            }
                                            g < Math.abs(o) && c.redrawColumnAtPosition(a.grid, e, 0)
                                        } else if (o > 0) {
                                            for (var i = 0, j = e + 1; j < b.length; j++)if ((angular.isUndefined(b[j].colDef.visible) || b[j].colDef.visible === !0) && (i += b[j].drawnWidth || b[j].width || b[j].colDef.width, i > o)) {
                                                c.redrawColumnAtPosition(a.grid, e, j - 1);
                                                break
                                            }
                                            o > i && c.redrawColumnAtPosition(a.grid, e, b.length - 1)
                                        }
                                        d.off("mousemove", t), d.off("mouseup", u)
                                    };
                                    d.on("mouseup", u)
                                }
                            }
    ...
    a.service("uiGridPaginationService", ["gridUtil", function (a) {
        var b = {
            initializeGrid: function (a) {
                ...
                a.api.registerEventsFromObject(c.events), a.api.registerMethodsFromObject(c.methods), a.registerRowsProcessor(function (b) {
                    if (a.options.useExternalPagination || !a.options.enablePagination)return b;
                    var c = parseInt(a.options.paginationPageSize, 10), d = parseInt(a.options.paginationCurrentPage, 10), e = b.filter(function (a) {
                        return a.visible
                    });
        ...
        return {
            priority: -200, scope: !0, require: "^uiGrid", link: function (e, f, g, h) {
                e.paginationApi = h.grid.api.pagination, e.sizesLabel = d.getSafeText("pagination.sizes"), e.totalItemsLabel = d.getSafeText("pagination.totalItems");
                var i = h.grid.options;
                h.grid.renderContainers.body.registerViewportAdjuster(function (a) {
                    return a.height = a.height - c.elementHeight(f), a
                });
                var j = h.grid.registerDataChangeCallback(function (a) {
                    a.options.useExternalPagination || (a.options.totalItems = a.rows.length)
                }, [b.dataChange.ROW]);
                e.$on("$destroy", j);
                var k = function () {
                    e.showingLow = (i.paginationCurrentPage - 1) * i.paginationPageSize + 1, e.showingHigh = Math.min(i.paginationCurrentPage * i.paginationPageSize, i.totalItems)
                }, l = e.$watch("grid.options.totalItems + grid.options.paginationPageSize", k), m = e.$watch("grid.options.paginationCurrentPage + grid.options.paginationPageSize", function (b, c) {
                    if (b !== c) {
                        if (!angular.isNumber(i.paginationCurrentPage) || i.paginationCurrentPage < 1)return void(i.paginationCurrentPage = 1);
                        if (i.totalItems > 0 && i.paginationCurrentPage > e.paginationApi.getTotalPages())return void(i.paginationCurrentPage = e.paginationApi.getTotalPages());
                        k(), a.onPaginationChanged(e.grid, i.paginationCurrentPage, i.paginationPageSize)
                    }
                });
                e.$on("$destroy", function () {
                    l(), m()
                }), e.cantPageForward = function () {
                    return i.totalItems > 0 ? i.paginationCurrentPage >= e.paginationApi.getTotalPages() : i.data.length < 1
                }, e.cantPageToLast = function () {
                    return i.totalItems > 0 ? e.cantPageForward() : !0
                }, e.cantPageBackward = function () {
                    return i.paginationCurrentPage <= 1
                }
            }
        }
    }])
    ...
    a.service("uiGridPinningService", ["gridUtil", "GridRenderContainer", "i18nService", function (a, b, c) {
        var d = {
            initializeGrid: function (a) {
                d.defaultGridOptions(a.options), a.registerColumnBuilder(d.pinningColumnBuilder)
            }, defaultGridOptions: function (a) {
                a.enablePinning = a.enablePinning !== !1
            }, pinningColumnBuilder: function (b, d, e) {
                if (b.enablePinning = void 0 === b.enablePinning ? e.enablePinning : b.enablePinning, b.pinnedLeft ? "*" === d.width ? d.grid.refresh().then(function () {
                        d.renderContainer = "left", d.width = d.grid.canvasWidth / d.grid.columns.length, d.grid.createLeftContainer()
                    }) : (d.renderContainer = "left", d.grid.createLeftContainer()) : b.pinnedRight && ("*" === d.width ? d.grid.refresh().then(function () {
                        d.renderContainer = "right", d.width = d.grid.canvasWidth / d.grid.columns.length, d.grid.createRightContainer()
                    }) : (d.renderContainer = "right", d.grid.createRightContainer())), b.enablePinning) {
                    var f = {
                        ...
                        action: function () {
                            this.context.col.renderContainer = "left", this.context.col.width = this.context.col.drawnWidth, this.context.col.grid.createLeftContainer(), d.grid.refresh().then(function () {
                                d.grid.refresh()
                            })
                        }
                    }, g = {
                        ...
                        action: function () {
                            this.context.col.renderContainer = "right", this.context.col.width = this.context.col.drawnWidth, this.context.col.grid.createRightContainer(), d.grid.refresh().then(function () {
                                d.grid.refresh()
                            })
                        }
                    }, h = {
                        ...
                        action: function () {
                            this.context.col.renderContainer = null, d.grid.refresh().then(function () {
                                d.grid.refresh()
                            })
                        }
                    };
                    a.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.pinning.pinLeft") || d.menuItems.push(f), a.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.pinning.pinRight") || d.menuItems.push(g), a.arrayContainsObjectWithProperty(d.menuItems, "name", "ui.grid.pinning.unpin") || d.menuItems.push(h)
                }
            }
        };
        return d
    ...
    a.service("uiGridResizeColumnsService", ["gridUtil", "$q", "$timeout", function (a, b, c) {
        var d = {
            defaultGridOptions: function (a) {
                ...
                a.api.registerEventsFromObject(b.events)
            }, fireColumnSizeChanged: function (a, b, d) {
                c(function () {
                    a.api.colResizable.raise.columnSizeChanged(b, d)
                })
        ...
        var e, f, g, h = angular.element('<div class="ui-grid-resize-overlay"></div>');
        b.isTouchEnabled() ? (e = "touchstart", f = "touchend", g = "touchmove") : (e = "mousedown", f = "mouseup", g = "mousemove");
        var i = {
            priority: 0,
            ...
            link: function (i, j, k, l) {
                function m(a) {
                    var b = a.getRenderContainer();
                    b.visibleColumnCache.forEach(function (b) {
                        if (b !== a) {
                            var c = b.colDef;
                            (!c.width || angular.isString(c.width) && (-1 !== c.width.indexOf("*") || -1 !== c.width.indexOf("%"))) && (b.width = b.drawnWidth)
                        }
                    })
                }
                ...
                function n() {
                    l.grid.buildColumns().then(function () {
                        l.grid.refreshCanvas(!0).then(function () {
                            l.grid.refresh()
                        })
                    })
                }
                ...
                function o(a, b) {
                    var c = b;
                    return a.colDef.minWidth && c < a.colDef.minWidth ? c = a.colDef.minWidth : a.colDef.maxWidth && c > a.colDef.maxWidth && (c = a.colDef.maxWidth), c
                }

                function p(a) {
                    a.originalEvent && (a = a.originalEvent), a.preventDefault(), s = (a.targetTouches ? a.targetTouches[0] : a).clientX - t, 0 > s ? s = 0 : s > l.grid.gridWidth && (s = l.grid.gridWidth);
                    var b = d.findTargetCol(i.col, i.position, u);
                    if (b.colDef.enableColumnResizing !== !1) {
                        l.grid.element.hasClass("column-resizing") || l.grid.element.addClass("column-resizing");
                        var e = s - r, f = parseInt(b.drawnWidth + e * u, 10);
                        s += (o(b, f) - f) * u, h.css({left: s + "px"}), l.fireEvent(c.events.ITEM_DRAGGING)
                    }
                }

                function q(b) {
                    b.originalEvent && (b = b.originalEvent), b.preventDefault(), l.grid.element.removeClass("column-resizing"), h.remove(), s = (b.changedTouches ? b.changedTouches[0] : b).clientX - t;
                    var c = s - r;
                    if (0 === c)return a.off(f, q), void a.off(g, p);
                    var e = d.findTargetCol(i.col, i.position, u);
                    if (e.colDef.enableColumnResizing !== !1) {
                        var j = parseInt(e.drawnWidth + c * u, 10);
                        e.width = o(e, j), m(e), n(c), d.fireColumnSizeChanged(l.grid, e.colDef, c), a.off(f, q), a.off(g, p)
                    }
                }

                var r = 0, s = 0, t = 0, u = 1;
                l.grid.isRTL() && (i.position = "left", u = -1), "left" === i.position ? j.addClass("left") : "right" === i.position && j.addClass("right"), j.on(e, function (b) {
                    b.originalEvent && (b = b.originalEvent), b.stopPropagation(), t = l.grid.element[0].getBoundingClientRect().left, r = (b.targetTouches ? b.targetTouches[0] : b).clientX - t, l.grid.element.append(h), h.css({left: r}), a.on(f, q), a.on(g, p)
                }), j.on("dblclick", function (a) {
                    a.stopPropagation();
                    var e = d.findTargetCol(i.col, i.position, u);
                    if (e.colDef.enableColumnResizing !== !1) {
                        var f = 0, g = 0, h = b.closestElm(j, ".ui-grid-render-container"), k = h.querySelectorAll("." + c.COL_CLASS_PREFIX + e.uid + " .ui-grid-cell-contents");
                        Array.prototype.forEach.call(k, function (a) {
                            ...
                            angular.element(a).parent().hasClass("ui-grid-header-cell") && (c = angular.element(a).parent()[0].querySelectorAll(".ui-grid-column-menu-button")), b.fakeElement(a, {}, function (a) {
                                ...
                                if (c) {
                                    var h = b.elementWidth(c);
                                    e += h
                                }
                                e > f && (f = e, g = f - e)
                            })
                        }), e.width = o(e, f), m(e), n(g), d.fireColumnSizeChanged(l.grid, e.colDef, g)
                    }
                }), j.on("$destroy", function () {
                    j.off(e), j.off("dblclick"), a.off(g, p), a.off(f, q)
                })
            }
        };
        return i
    ...
    a.constant("uiGridRowEditConstants", {}), a.service("uiGridRowEditService", ["$interval", "$q", "uiGridConstants", "uiGridRowEditConstants", "gridUtil", function (a, b, c, d, e) {
        var f = {
            initializeGrid: function (a, b) {
                ...
                b.api.registerEventsFromObject(c.events), b.api.registerMethodsFromObject(c.methods), b.api.core.on.renderingComplete(a, function () {
                ...
                var c = this;
                return function () {
                    delete b.isSaving, delete b.isDirty, delete b.isError, delete b.rowEditSaveTimer, c.removeRow(a.rowEdit.errorRows, b), c.removeRow(a.rowEdit.dirtyRows, b)
                }
            }, processErrorPromise: function (a, b) {
                return function () {
                    delete b.isSaving, delete b.rowEditSaveTimer, b.isError = !0, a.rowEdit.errorRows || (a.rowEdit.errorRows = []), f.isRowPresent(a.rowEdit.errorRows, b) || a.rowEdit.errorRows.push(b)
                }
                ...
                var c = [];
                return angular.forEach(a.rowEdit.dirtyRows, function (b) {
                ...
                var b = this.grid, c = b.getRow(a);
                return c ? void f.cancelTimer(b, c) : void e.logError("Unable to find rowEntity in grid data, timer cannot be cancelled")
            }, cancelEditCell: function (a) {
                var b = this.grid, c = b.getRow(a);
                return c ? void f.considerSetTimer(b, c) : void e.logError("Unable to find rowEntity in grid data, timer cannot be set")
        ...
        return f
    }]), a.directive("uiGridRowEdit", ["gridUtil", "uiGridRowEditService", "uiGridEditConstants", function (a, b) {
        return {
            replace: !0, priority: 0, require: "^uiGrid", scope: !1, compile: function () {
                return {
                    pre: function (a, c, d, e) {
    ...
    }]), a.directive("uiGridViewport", ["$compile", "uiGridConstants", "gridUtil", "$parse", function () {
        return {
            priority: -200, scope: !1, compile: function (a) {
                var b = angular.element(a.children().children()[0]), c = b.attr("ng-class"), d = "";
                return d = c ? c.slice(0, -1) + ", 'ui-grid-row-dirty': row.isDirty, 'ui-grid-row-saving': row.isSaving, 'ui-grid-row-error': row.isError}" : "{'ui-grid-row-dirty': row.isDirty, 'ui-grid-row-saving': row.isSaving, 'ui-grid-row-error': row.isError}", b.attr("ng-class", d), {
                    pre: function () {
                    }, post: function () {
                    }
                }
    ...
    "use strict";
    var a = angular.module("ui.grid.saveState", ["ui.grid", "ui.grid.selection", "ui.grid.cellNav"]);
    a.constant("uiGridSaveStateConstants", {featureName: "saveState"}), a.service("uiGridSaveStateService", ["$q", "uiGridSaveStateConstants", "gridUtil", "$compile", "$interval", "uiGridConstants", function () {
        var a = {
            initializeGrid: function (b) {
                b.saveState = {}, this.defaultGridOptions(b.options);
                var c = {
                ...
                b.api.registerEventsFromObject(c.events), b.api.registerMethodsFromObject(c.methods)
            }, defaultGridOptions: function (a) {
                a.saveWidths = a.saveWidths !== !1, a.saveOrder = a.saveOrder !== !1, a.saveScroll = a.saveScroll === !0, a.saveFocus = a.saveScroll !== !0 && a.saveFocus !== !1, a.saveVisible = a.saveVisible !== !1, a.saveSort = a.saveSort !== !1, a.saveFilter = a.saveFilter !== !1, a.saveSelection = a.saveSelection !== !1
            }, save: function (b) {
                var c = {};
                return c.columns = a.saveColumns(b), c.scrollFocus = a.saveScrollFocus(b), c.selection = a.saveSelection(b), c
            }, restore: function (b, c, d) {
                d.columns && a.restoreColumns(b, d.columns), d.scrollFocus && a.restoreScrollFocus(b, c, d.scrollFocus), d.selection && a.restoreSelection(b, d.selection), b.refresh()
            }, saveColumns: function (a) {
                var b = [];
                return angular.forEach(a.columns, function (a) {
                    var c = {};
                    c.name = a.name, c.visible = a.visible, c.width = a.width, c.sort = angular.copy(a.sort), c.filters = angular.copy(a.filters), b.push(c)
                }), b
            }, saveScrollFocus: function (b) {
                if (!b.api.cellNav)return {};
                var c = {};
                if (b.options.saveFocus) {
                    c.focus = !0;
                    var d = b.api.cellNav.getFocusedCell();
                    null !== d && (c.colName = d.col.colDef.name, c.rowVal = a.getRowVal(b, d.row))
                } else b.options.saveScroll && (c.focus = !1, b.renderContainers.body.prevRowScrollIndex && (c.rowVal = a.getRowVal(b, b.renderContainers.body.visibleRowCache[b.renderContainers.body.prevRowScrollIndex])), b.renderContainers.body.prevColScrollIndex && (c.colName = b.renderContainers.body.visibleColumnCache[b.renderContainers.body.prevColScrollIndex].name));
                return c
            }, saveSelection: function (b) {
                if (!b.api.selection || !b.options.saveSelection)return {};
                var c = b.api.selection.getSelectedGridRows().map(function (c) {
                    return a.getRowVal(b, c)
                });
                return c
                ...
                angular.forEach(b, function (b, c) {
                    var d = a.columns.filter(function (a) {
                        return a.name === b.name
                    });
                    if (d.length > 0) {
                        var e = a.columns.indexOf(d[0]);
                        if ((a.columns[e].visible !== b.visible || a.columns[e].colDef.visible !== b.visible) && (a.columns[e].visible = b.visible, a.columns[e].colDef.visible = b.visible, a.api.core.raise.columnVisibilityChanged(a.columns[e])), a.columns[e].width = b.width, angular.equals(a.columns[e].sort, b.sort && !(void 0 === a.columns[e].sort && angular.isEmpty(b.sort))) || (a.columns[e].sort = angular.copy(b.sort), a.api.core.raise.sortChanged()), angular.equals(a.columns[e].filters, b.filters) || (a.columns[e].filters = angular.copy(b.filters), a.api.core.raise.filterChanged()), e !== c) {
                            var f = a.columns.splice(e, 1)[0];
                            a.columns.splice(c, 0, f)
                        }
                    }
                })
            }, restoreScrollFocus: function (b, c, d) {
                if (b.api.cellNav) {
                    var e, f;
                    if (d.colName) {
                        var g = b.options.columnDefs.filter(function (a) {
                            return a.name === d.colName
                        });
                        g.length > 0 && (e = g[0])
                    }
                    d.rowVal && d.rowVal.row && (f = d.rowVal.identity ? a.findRowByIdentity(b, d.rowVal) : b.renderContainers.body.visibleRowCache[d.rowVal.row]);
                    var h = f && f.entity ? f.entity : null;
                    (e || h) && (d.focus ? b.api.cellNav.scrollToFocus(h, e) : b.api.cellNav.scrollTo(h, e))
                }
            }, restoreSelection: function (b, c) {
                b.api.selection && (b.api.selection.clearSelectedRows(), angular.forEach(c, function (c) {
                    if (c.identity) {
                        var d = a.findRowByIdentity(b, c);
                        d && b.api.selection.selectRow(d.entity)
                    } else b.api.selection.selectRowByVisibleIndex(c.row)
                }))
        ...
        return a
    }]), a.directive("uiGridSaveState", ["uiGridSaveStateConstants", "uiGridSaveStateService", "gridUtil", "$compile", function (a, b) {
        return {
            replace: !0, priority: 0, require: "^uiGrid", scope: !1, link: function (a, c, d, e) {
                b.initializeGrid(e.grid)
            }
    ...
    a.constant("uiGridSelectionConstants", {
    ...
    }]), a.service("uiGridSelectionService", ["$q", "$templateCache", "uiGridSelectionConstants", "gridUtil", function () {
        var a = {
            initializeGrid: function (b) {
                b.selection = {}, b.selection.lastSelectedRow = null, b.selection.selectAll = !1, b.selection.selectedCount = 0, a.defaultGridOptions(b.options);
                var c = {
                    events: {
                        selection: {
                        ...
                        selection: {
                            toggleRowSelection: function (c, d) {
                                var e = b.getRow(c);
                                null !== e && e.enableSelection !== !1 && a.toggleRowSelection(b, e, d, b.options.multiSelect, b.options.noUnselect)
                            }, selectRow: function (c, d) {
                                var e = b.getRow(c);
                                null === e || e.isSelected || e.enableSelection === !1 || a.toggleRowSelection(b, e, d, b.options.multiSelect, b.options.noUnselect)
                            }, selectRowByVisibleIndex: function (c, d) {
                                var e = b.renderContainers.body.visibleRowCache[c];
                                null === e || "undefined" == typeof e || e.isSelected || e.enableSelection === !1 || a.toggleRowSelection(b, e, d, b.options.multiSelect, b.options.noUnselect)
                            }, unSelectRow: function (c, d) {
                                var e = b.getRow(c);
                                null !== e && e.isSelected && a.toggleRowSelection(b, e, d, b.options.multiSelect, b.options.noUnselect)
                            }, selectAllRows: function (c) {
                                if (b.options.multiSelect !== !1) {
                                    var d = [];
                                    b.rows.forEach(function (e) {
                                        e.isSelected || e.enableSelection === !1 || (e.setSelected(!0), a.decideRaiseSelectionEvent(b, e, d, c))
                                    }), a.decideRaiseSelectionBatchEvent(b, d, c), b.selection.selectAll = !0
                                }
                            }, selectAllVisibleRows: function (c) {
                                if (b.options.multiSelect !== !1) {
                                    var d = [];
                                    b.rows.forEach(function (e) {
                                        e.visible ? e.isSelected || e.enableSelection === !1 || (e.setSelected(!0), a.decideRaiseSelectionEvent(b, e, d, c)) : e.isSelected && (e.setSelected(!1), a.decideRaiseSelectionEvent(b, e, d, c))
                                    }), a.decideRaiseSelectionBatchEvent(b, d, c), b.selection.selectAll = !0
                                }
                            }, clearSelectedRows: function (c) {
                                a.clearSelectedRows(b, c)
                            }, getSelectedRows: function () {
                                return a.getSelectedRows(b).map(function (a) {
                                    return a.entity
                                })
                            }, getSelectedGridRows: function () {
                                return a.getSelectedRows(b)
                            }, setMultiSelect: function (a) {
                                b.options.multiSelect = a
                            }, setModifierKeysToMultiSelect: function (a) {
                                b.options.modifierKeysToMultiSelect = a
                            }, getSelectAllState: function () {
                                return b.selection.selectAll
                            }
                        }
                    }
                };
                ...
                a.enableRowSelection = a.enableRowSelection !== !1, a.multiSelect = a.multiSelect !== !1, a.noUnselect = a.noUnselect === !0, a.modifierKeysToMultiSelect = a.modifierKeysToMultiSelect === !0, a.enableRowHeaderSelection = a.enableRowHeaderSelection !== !1, a.enableSelectAll = a.enableSelectAll !== !1, a.enableSelectionBatchEvent = a.enableSelectionBatchEvent !== !1, a.selectionRowHeaderWidth = angular.isDefined(a.selectionRowHeaderWidth) ? a.selectionRowHeaderWidth : 30, a.enableFooterTotalSelected = a.enableFooterTotalSelected !== !1, a.isRowSelectable = angular.isDefined(a.isRowSelectable) ? a.isRowSelectable : angular.noop
            }, toggleRowSelection: function (b, c, d, e, f) {
                var g = c.isSelected;
                if (e || g) {
                    if (!e && g) {
                        var h = a.getSelectedRows(b);
                        h.length > 1 && (g = !1, a.clearSelectedRows(b, d))
                    }
                } else a.clearSelectedRows(b, d);
                g && f || c.enableSelection !== !1 && (c.setSelected(!g), c.isSelected === !0 ? b.selection.lastSelectedRow = c : b.selection.selectAll = !1, b.api.selection.raise.rowSelectionChanged(c, d))
            }, shiftSelect: function (b, c, d, e) {
                if (e) {
                    var f = a.getSelectedRows(b), g = f.length > 0 ? b.renderContainers.body.visibleRowCache.indexOf(b.selection.lastSelectedRow) : 0, h = b.renderContainers.body.visibleRowCache.indexOf(c);
                    if (g > h) {
                        var i = g;
                        g = h, h = i
                    }
                    for (var j = [], k = g; h >= k; k++) {
                        var l = b.renderContainers.body.visibleRowCache[k];
                        l && (l.isSelected || l.enableSelection === !1 || (l.setSelected(!0), b.selection.lastSelectedRow = l, a.decideRaiseSelectionEvent(b, l, j, d)))
                    }
                    a.decideRaiseSelectionBatchEvent(b, j, d)
                }
            }, getSelectedRows: function (a) {
                return a.rows.filter(function (a) {
                    return a.isSelected
                })
            }, clearSelectedRows: function (b, c) {
                var d = [];
                a.getSelectedRows(b).forEach(function (e) {
                    e.isSelected && (e.setSelected(!1), a.decideRaiseSelectionEvent(b, e, d, c))
                }), a.decideRaiseSelectionBatchEvent(b, d, c), b.selection.selectAll = !1
        ...
        return a
    }]), a.directive("uiGridSelection", ["uiGridSelectionConstants", "uiGridSelectionService", "$templateCache", function (a, b) {
        return {
            replace: !0, priority: 0, require: "^uiGrid", scope: !1, compile: function () {
                return {
                    pre: function (c, d, e, f) {
                        if (b.initializeGrid(f.grid), f.grid.options.enableRowHeaderSelection) {
                            var g = {
                                name: a.selectionRowHeaderColName,
                                displayName: "",
                                width: f.grid.options.selectionRowHeaderWidth,
                                minWidth: 10,
                        ...
                        f.grid.options.isRowSelectable !== angular.noop && f.grid.registerRowBuilder(function (a) {
                            a.enableSelection = f.grid.options.isRowSelectable(a)
                        })
                    }, post: function () {
                    }
                }
    ...
    }]), a.directive("uiGridSelectionRowHeaderButtons", ["$templateCache", "uiGridSelectionService", function (a, b) {
        return {
            replace: !0,
            restrict: "E",
            ...
            link: function (a, c, d, e) {
                var f = e.grid;
                a.selectButtonClick = function (a, c) {
                    c.shiftKey ? b.shiftSelect(f, a, c, f.options.multiSelect) : c.ctrlKey || c.metaKey ? b.toggleRowSelection(f, a, c, f.options.multiSelect, f.options.noUnselect) : b.toggleRowSelection(f, a, c, f.options.multiSelect && !f.options.modifierKeysToMultiSelect, f.options.noUnselect)
                }
            }
        }
        ...
        return {
            ...
            link: function (a) {
                var c = a.col.grid;
                a.headerButtonClick = function (a, d) {
                    c.selection.selectAll ? (b.clearSelectedRows(c, d), c.options.noUnselect && c.api.selection.selectRowByVisibleIndex(0, d), c.selection.selectAll = !1) : c.options.multiSelect && (c.api.selection.selectAllVisibleRows(d), c.selection.selectAll = !0)
                }
            }
        }
    }]), a.directive("uiGridViewport", ["$compile", "uiGridConstants", "uiGridSelectionConstants", "gridUtil", "$parse", "uiGridSelectionService", function () {
        return {
            priority: -200, scope: !1, compile: function (a) {
                var b = angular.element(a.children().children()[0]), c = b.attr("ng-class"), d = "";
                return d = c ? c.slice(0, -1) + ",'ui-grid-row-selected': row.isSelected}" : "{'ui-grid-row-selected': row.isSelected}", b.attr("ng-class", d), {
                    pre: function () {
                    }, post: function () {
                    }
                }
    ...
    }]), a.directive("uiGridCell", ["$compile", "uiGridConstants", "uiGridSelectionConstants", "gridUtil", "$parse", "uiGridSelectionService", function (a, b, c, d, e, f) {
        return {
            priority: -200, restrict: "A", scope: !1, link: function (a, c) {
                function d() {
                    a.grid.options.enableRowSelection && !a.grid.options.enableRowHeaderSelection && (c.addClass("ui-grid-disable-selection"), c.on("touchstart", j), c.on("touchend", k), c.on("click", i), a.registered = !0)
                }

                function e() {
                    a.registered && (c.removeClass("ui-grid-disable-selection"), c.off("touchstart", j), c.off("touchend", k), c.off("click", i), a.registered = !1)
                }

                var g = 0, h = 300, i = function (b) {
                    b.shiftKey ? f.shiftSelect(a.grid, a.row, b, a.grid.options.multiSelect) : b.ctrlKey || b.metaKey ? f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect, a.grid.options.noUnselect) : f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect && !a.grid.options.modifierKeysToMultiSelect, a.grid.options.noUnselect), a.$apply()
                }, j = function () {
                    g = (new Date).getTime()
                }, k = function (a) {
                    var b = (new Date).getTime(), c = b - g;
                    h > c && i(a)
                };
                d();
                var l = a.grid.registerDataChangeCallback(function () {
                    !a.grid.options.enableRowSelection || a.grid.options.enableRowHeaderSelection || a.registered ? a.grid.options.enableRowSelection && !a.grid.options.enableRowHeaderSelection || !a.registered || e() : d()
        ...
        return {
            restrict: "EA", replace: !0, priority: -1e3, require: "^uiGrid", scope: !0, compile: function () {
                return {
