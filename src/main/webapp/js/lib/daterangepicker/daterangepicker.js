...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        console.log("before set options" + cb);
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            if (typeof options.isOneDate === 'boolean') {
                this.isOneDate = options.isOneDate;
            }
    ...
    $.fn.daterangepicker = function (options, cb, linstner) {
        this.each(function () {
            var el = $(this);
            if (el.data('daterangepicker'))
                el.data('daterangepicker').remove();
            el.data('daterangepicker', new DateRangePicker(el, options, cb, linstner));
        });
        return this;
    };
