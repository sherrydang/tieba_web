...
import com.geetion.drools.config.DroolsKieConfig;
...
@WebAppConfiguration
@ContextConfiguration(classes = { DroolsKieConfig.class }, loader = AnnotationConfigWebContextLoader.class)
...
//    	Collection<Alarm> res=occsRuleService.removeFire(fires);
//    	System.out.println("-------------->>> Alarms: "+res.toString());
